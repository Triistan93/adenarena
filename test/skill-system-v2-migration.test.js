...
test('1. V2 Catalog Integrity: 46 Lineages, 142 Classes, 761 Skills, 0 Silent Gaps', () => {
  ...
  assert.equal(report.metrics.totalSkills, 761, 'Must contain exactly 761 unique canonical skills');
