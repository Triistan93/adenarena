...
export const AFFIX_POOL = [
  // ÔöÇÔöÇ STAT AFFIXES (type: 'stat') ÔöÇÔöÇ
  { id: 'crit_boost',      name: '+{value}% Cr├¡tico',           type: 'stat', stat: 'crit',      min: 3, max: 8 },
  { id: 'eva_boost',       name: '+{value}% Evas├úo',            type: 'stat', stat: 'eva',       min: 3, max: 8 },
  ...
  { id: 'def_boost',       name: '+{value}% Defesa F├¡sica',     type: 'stat', stat: 'def',       min: 5, max: 15 },
  { id: 'matk_boost',      name: '+{value}% Ataque M├ígico',     type: 'stat', stat: 'matk',      min: 5, max: 15 },
  { id: 'mdef_boost',      name: '+{value}% Defesa M├ígica',     type: 'stat', stat: 'mdef',      min: 5, max: 15 },
  { id: 'hp_boost',        name: '+{value}% HP M├íximo',         type: 'stat', stat: 'hp',        min: 5, max: 20 },
  { id: 'mp_boost',        name: '+{value}% MP M├íximo',         type: 'stat', stat: 'mp',        min: 5, max: 20 },

  // ÔöÇÔöÇ PROC / CONDITIONAL AFFIXES (type: 'proc') ÔöÇÔöÇ
  ...
  { id: 'dragon_dmg',      name: '+{value}% Dano vs Drag├Áes',   type: 'proc', proc: 'type_dmg', category: 'dragon', min: 10, max: 30 },
  { id: 'beast_dmg',       name: '+{value}% Dano vs Bestas',    type: 'proc', proc: 'type_dmg', category: 'beast', min: 10, max: 30 },
  { id: 'demon_dmg',       name: '+{value}% Dano vs Dem├┤nios',  type: 'proc', proc: 'type_dmg', category: 'demon', min: 10, max: 30 },
