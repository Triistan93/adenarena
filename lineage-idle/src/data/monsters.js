...
export const MONSTERS = {
  ...
  goblinMage: { name: 'Goblin Mage', lvl: 4, hp: 50, atk: 8, def: 3, eva: 3, matk: 16, mdef: 6, xp: 25, sp: 1, gold: [12, 28] },
  ...
  rootWitch: { name: 'Root Witch', lvl: 5, hp: 85, atk: 14, def: 5, eva: 4, matk: 20, mdef: 8, xp: 32, sp: 1, gold: [15, 32] },
  deathTrent: { name: 'Death Treant', lvl: 6, hp: 350, atk: 28, def: 15, eva: 2, matk: 12, mdef: 10, xp: 180, sp: 4, gold: [80, 180], boss: true },

  // Dark Forest (Level 5-8)
  spider: { name: 'Cave Spider', lvl: 5, hp: 75, atk: 13, def: 4, eva: 8, matk: 0, mdef: 3, xp: 28, sp: 1, gold: [12, 28] },
  swampWalker: { name: 'Swamp Walker', lvl: 7, hp: 120, atk: 18, def: 7, eva: 5, matk: 10, mdef: 6, xp: 42, sp: 2, gold: [18, 40] },

  // Orc Village (Level 7-10)
  orc: { name: 'Orc Warrior', lvl: 7, hp: 150, atk: 22, def: 9, eva: 4, matk: 0, mdef: 4, xp: 50, sp: 2, gold: [22, 48], element: 'none', traits: ['enrage'] },

  // Dwarven Mine (Level 9-12)
  kobold: { name: 'Kobold Miner', lvl: 9, hp: 180, atk: 26, def: 11, eva: 4, matk: 0, mdef: 5, xp: 65, sp: 2, gold: [28, 60] },
  koboldLeader: { name: 'Kobold Foreman', lvl: 11, hp: 480, atk: 42, def: 18, eva: 8, matk: 0, mdef: 8, xp: 220, sp: 4, gold: [100, 220], element: 'none', traits: ['packLeader'], elite: true },
  ...
  ruinedGoblinThief: { name: 'Outpost Thief', lvl: 14, hp: 320, atk: 42, def: 16, eva: 12, xp: 130, sp: 3, gold: [50, 110] },
  ruinedOrc: { name: 'Outpost Orc', lvl: 15, hp: 420, atk: 50, def: 20, eva: 5, xp: 160, sp: 3, gold: [60, 130] },
  shadowMercenary: { name: 'Shadow Mercenary', lvl: 17, hp: 750, atk: 72, def: 28, eva: 10, xp: 320, sp: 5, gold: [120, 260], elite: true },
  ...
  cursedWarrior: { name: 'Cursed Warrior', lvl: 32, hp: 2400, atk: 195, def: 75, eva: 8, xp: 1350, sp: 9, gold: [450, 950] },
  ...
  devilBone: { name: 'Devil Bone', lvl: 39, hp: 4200, atk: 280, def: 115, eva: 3, xp: 2700, sp: 13, gold: [850, 1800], element: 'dark', traits: ['boneArmor'] },
  ...
  deathWizard: { name: 'Death Wizard Archon', lvl: 42, hp: 4400, atk: 180, def: 95, eva: 10, matk: 340, mdef: 145, xp: 3500, sp: 15, gold: [1150, 2500] },
  blackDragon: { name: 'Black Dragon Sovereign', lvl: 43, hp: 12000, atk: 450, def: 180, eva: 10, xp: 8500, sp: 25, gold: [3200, 7000], boss: true },
  ...
  cursedKnight: { name: 'Cursed Gludio Knight', lvl: 47, hp: 6800, atk: 400, def: 165, eva: 6, xp: 4800, sp: 18, gold: [1500, 3200] },
  ...
  mountainDireWolf: { name: 'Mountain Dire Wolf', lvl: 49, hp: 7400, atk: 430, def: 170, eva: 18, xp: 5200, sp: 20, gold: [1700, 3600] },
