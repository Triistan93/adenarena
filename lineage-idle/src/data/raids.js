/**
 * raids.js ÔÇö Defini├º├Áes dos Raid Bosses do Lineage Idle.
 * Extra├¡do de lineage-idle/main.js (linhas 2528-2534)
 */
export const RAID_BOSSES = {
  ...
  zaken: {
    id: 'zaken',
    name: 'Zaken o Pirata ­ƒÅ┤ÔÇìÔÿá´©Å',
    lvl: 60, hp: 35000, atk: 320, def: 110, eva: 15,
    xp: 25000, sp: 200, gold: [15000, 30000],
    boss: true, raid: true,
    reqLvl: 50,
    desc: 'Capit├úo pirata da Ilha do Diabo. Drop: Earring of Zaken'
  },
  baium: {
    id: 'baium',
    name: 'Imperador Baium ÔÜí',
  ...
  antharas: {
    id: 'antharas',
    name: 'Drag├úo Antharas ­ƒÉë',
    lvl: 95, hp: 220000, atk: 850, def: 280, eva: 10,
    xp: 300000, sp: 1500, gold: [150000, 350000],
    boss: true, raid: true,
    reqLvl: 85,
    desc: 'Drag├úo da Terra. Drops: Earring of Antharas & Dragon Slayer'
  },
  valakas: {
    id: 'valakas',
    name: 'Drag├úo Valakas ­ƒöÑ',
    lvl: 100, hp: 450000, atk: 1200, def: 380, eva: 8,
    xp: 750000, sp: 3500, gold: [400000, 800000],
    boss: true, raid: true,
    reqLvl: 90,
    desc: 'Senhor do Vulc├úo. Drops: Facemask & Necklace of Valakas'
  }
};