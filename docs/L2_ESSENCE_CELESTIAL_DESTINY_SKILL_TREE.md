# 🌟 CATÁLOGO COMPLETO DE CLASSES & HABILIDADES — LINEAGE II ESSENCE (CELESTIAL DESTINY - 29/07/2026)

> Atualizado com base no patch 3629 (Celestial Destiny) do Lineage II Essence.
> Contém a árvore completa de habilidades desde o Nível 1 até a 3ª Classe, incluindo ícones oficiais, tipo, efeito e tempo de recarga.

## ⚔️ Linhagem: Duelist (HUMAN)
...
* **Descrição:** Classe base de combate humana.
    --- Skills:
        ...
        • **Rush** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `15s`) — Avança ao alvo + dano 120% *(Investida rápida contra o inimigo.)*
        ...
        • **Light Armor Mastery** ![Skill](/icons/skill0233.webp) [Passivo] (Recarga: `N/A`) — +8% DEF com armadura leve *(Maestria em armaduras leves.)*
...
* **Descrição:** Guerreiro corpo-a-corpo especializado em espadas e polearms. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Spinning Slash** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `12s`) — Dano AoE 160% ao redor *(Giro cortante ao redor.)*
        ...
        • **War Cry** ![Skill](/icons/skill0078.webp) [Ativo] (Recarga: `60s`) — +20% ATK para si por 60s *(Grito de guerra que inspira força.)*
        • **Battle Roar** ![Skill](/icons/skill0121.webp) [Self-Buff] (Recarga: `45 min`) — +25% ATK e +15% HP por 20 min *(Rugido de batalha.)*
        • **Sword/Blunt Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% ATK com espada/blunt *(Maestria em espadas e maças.)*
        • **Polearm Mastery** ![Skill](/icons/skill0216.webp) [Passivo] (Recarga: `N/A`) — +12% ATK com polearm *(Maestria em lanças.)*
        • **Heavy Armor Mastery** ![Skill](/icons/skill0231.webp) [Passivo] (Recarga: `N/A`) — +12% DEF com armadura pesada *(Maestria em armaduras pesadas.)*
...
* **Descrição:** Mestre em dual wield e combos devastadores. Skills anteriores permanecem.
    --- Skills:
        • **Triple Slash** ![Skill](/icons/skill0007.webp) [Ativo] (Recarga: `14s`) — 3 golpes, dano total 300% *(Três cortes rápidos consecutivos.)*
        ...
        • **Hammer Crush** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `20s`) — Dano 230% + stun 3s *(Esmagamento com martelo.)*
        • **Sonic Move** ![Skill](/icons/skill0451.webp) [Ativo] (Recarga: `20s`) — Teleporte curto + 180% dano *(Movimento sônico instantâneo.)*
        • **Lionheart** ![Skill](/icons/skill0287.webp) [Ativo] (Recarga: `120s`) — Imune a medo/stun por 15s *(Coração de leão — coragem inabalável.)*
        • **War Frenzy** ![Skill](/icons/skill0176.webp) [Self-Buff] (Recarga: `90s`) — +20% ATK Speed por 60s *(Frenesi de combate.)*
        • **Vicious Stance** ![Skill](/icons/skill0312.webp) [Toggle] (Recarga: `N/A`) — +25% Crit Rate, -10% DEF *(Postura agressiva permanente.)*
        • **Gladiator's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK e +20% Crit por 25 min *(Harmonia do gladiador.)*
        • **Dual Weapon Mastery** ![Skill](/icons/skill0144.webp) [Passivo] (Recarga: `N/A`) — +18% ATK com dual weapons *(Maestria em armas duplas.)*
        • **Focus** ![Skill](/icons/skill0019.webp) [Passivo] (Recarga: `N/A`) — +8% Crit Rate *(Concentração em pontos vitais.)*
...
* **Descrição:** Duelista supremo, mestre do dual wield. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Dual Blow** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `24s`) — Dano 400% + bleed 8s *(Golpe duplo sangrento.)*
        • **Rushing Force** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `22s`) — Rush + 320% dano + stun 2s *(Avanço forçado.)*
        • **Long Blow** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Dano 280% alcance estendido *(Golpe de longo alcance.)*
        • **Force Buster** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `26s`) — Dano AoE 360% frontal *(Explosão de força frontal.)*
        • **Earthquake** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `35s`) — Dano AoE 420% + knockdown 3s *(Terremoto devastador.)*
        • **Real Target** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Marca alvo: +30% dano contra ele 10s *(Identifica ponto fraco.)*
        ...
        • **Transcendent Dual Blow** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `150s`) — Dano 620% + bleed 12s + ignora DEF *(Golpe duplo transcendente.)*
        • **Duelist's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% ATK, +40% Crit, +20% Speed 30min *(Harmonia suprema do duelista.)*
...
* **Descrição:** Senhor da guerra com polearms e AoE devastador. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Provoke** ![Skill](/icons/skill0286.webp) [Ativo] (Recarga: `10s`) — Taunt single + dano 120% *(Provocação direta.)*
        ...
        • **War Cry** ![Skill](/icons/skill0078.webp) [Self-Buff] (Recarga: `90s`) — +25% ATK por 60s *(Grito de guerra do senhor.)*
        • **Warlord's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% ATK, +25% HP por 25 min *(Harmonia do senhor da guerra.)*
        • **Vital Force** ![Skill](/icons/skill0148.webp) [Passivo] (Recarga: `N/A`) — +10% HP Regen *(Força vital.)*
        • **Focus** ![Skill](/icons/skill0019.webp) [Passivo] (Recarga: `N/A`) — +8% Crit Rate *(Concentração.)*
...
* **Descrição:** Encouraçado vivo, AoE massivo com polearm. Skills anteriores permanecem.
    --- Skills:
        • **Rush Impact** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `25s`) — Rush + 350% dano + stun 3s *(Investida devastadora.)*
        • **Dread Pool** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `35s`) — AoE contínuo 200%/s por 5s (8 alvos) *(Área de terror.)*
        • **Spike** ![Skill](/icons/skill1148.webp) [Ativo] (Recarga: `28s`) — Dano 380% + penetra DEF 40% *(Estocada penetrante.)*
        ...
        • **Lionheart** ![Skill](/icons/skill0287.webp) [Ativo] (Recarga: `120s`) — Imune a medo/stun 15s *(Coração de leão.)*
        • **War Frenzy** ![Skill](/icons/skill0176.webp) [Self-Buff] (Recarga: `90s`) — +30% ATK Speed por 45s *(Frenesi total.)*
        • **Transcendent Whirlwind** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `160s`) — Dano AoE 600% + knockdown (12 alvos) *(Redemoinho transcendente.)*
        • **Dreadnought's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% ATK, +35% HP, +20% DEF 30min *(Harmonia do encouraçado.)*
...
## ⚔️ Linhagem: Phoenix Knight (HUMAN)
...
### Primeira Classe lvl 20-39: Knight ![Icon](/icons/knight.webp)
* **ID:** `knight` | **Ícone da Classe:** `/icons/knight.webp`
* **Descrição:** Cavaleiro tanque com escudo. Skills anteriores permanecem.
    --- Skills:
        • **Shield Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `10s`) — Dano 170% + taunt 5s *(Golpe de escudo.)*
        ...
        • **Knight's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `45 min`) — +25% DEF e +20% HP por 20 min *(Harmonia do cavaleiro.)*
        • **Heavy Armor Mastery** ![Skill](/icons/skill0231.webp) [Passivo] (Recarga: `N/A`) — +15% DEF com armadura pesada *(Maestria em armaduras pesadas.)*
        • **Shield Mastery** ![Skill](/icons/skill0153.webp) [Passivo] (Recarga: `N/A`) — +15% Block Rate *(Maestria em escudos.)*
        • **Sword/Blunt Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% ATK espada/blunt *(Maestria em espadas.)*
...
* **Descrição:** Cavaleiro sagrado, tank com cura e proteção. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Holy Strike** ![Skill](/icons/skill1027.webp) [Ativo] (Recarga: `20s`) — Dano sagrado 320% + undead 2x *(Golpe sagrado devastador.)*
        ...
        • **Provoke** ![Skill](/icons/skill0286.webp) [Ativo] (Recarga: `8s`) — Taunt + aggro forte *(Provocação.)*
        • **Paladin's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +40% DEF, +30% HP, +20% M.DEF 25min *(Harmonia do paladino.)*
        • **Resist Holy/Dark** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% resist holy/dark *(Resistência sagrada.)*
...
* **ID:** `phoenixKnight` | **Ícone da Classe:** `/icons/phoenix_knight.webp`
* **Descrição:** Cavaleiro da Fênix, tank supremo com ressurreição. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Phoenix Aura** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +45% DEF, +HP Regen 3%/s por 25min *(Aura da fênix.)*
        • **Shield of Faith** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `90s`) — Absorve 5000 dano por 15s *(Escudo de fé.)*
        ...
        • **Transcendent Shield Charge** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `160s`) — Rush + 500% dano + AoE taunt 10s *(Investida transcendente.)*
        • **Phoenix Knight's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% DEF, +40% HP, +30% M.DEF 30min *(Harmonia suprema.)*
...
* **ID:** `darkAvenger` | **Ícone da Classe:** `/icons/dark_avenger.webp`
* **Descrição:** Cavaleiro sombrio com pantera e drain. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Judgment** ![Skill](/icons/skill0401.webp) [Ativo] (Recarga: `22s`) — Dano dark 300% + -20% DEF 10s *(Julgamento sombrio.)*
        • **Touch of Death** ![Skill](/icons/skill0342.webp) [Ativo] (Recarga: `20s`) — Dano 280% + poison 10s *(Toque mortal.)*
        • **Dark Flame** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano AoE dark 240% *(Chamas sombrias.)*
        • **Doom Shield** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — Absorve 3000 dano + reflete 15% *(Escudo da perdição.)*
        • **Seed of Revenge** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `120s`) — Marca: ao morrer causa 500% dano *(Semente da vingança.)*
        • **Dark Avenger's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +30% DEF, +20% drain 25min *(Harmonia sombria.)*
...
* **ID:** `hellKnight` | **Ícone da Classe:** `/icons/hell_knight.webp`
* **Descrição:** Cavaleiro infernal com aura de trevas. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Touch of Darkness** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Dano 380% + silence 5s *(Toque das trevas.)*
        • **Summon Dark Panther Enhanced** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `120s`) — Pantera aprimorada (ATK 80% do dono) *(Pantera das trevas aprimorada.)*
        • **Transcendent Dark Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `150s`) — Dano 580% dark + drain 40% como HP *(Golpe sombrio transcendente.)*
        • **Hell Knight's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% ATK, +40% DEF, +30% drain 30min *(Harmonia infernal.)*
        ...
        • **Protection of Darkness** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% dark resist *(Proteção das trevas.)*

---

## ⚔️ Linhagem: Adventurer (HUMAN)
...
* **Descrição:** Ladino ágil, especialista em dagger e bow. Skills anteriores permanecem.
    --- Skills:
        • **Double Shot** ![Skill](/icons/skill0019.webp) [Ativo] (Recarga: `10s`) — 2 disparos, dano total 200% *(Duplo disparo.)*
        ...
        • **Rogue's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `45 min`) — +20% EVA, +15% Crit por 20 min *(Harmonia do ladino.)*
        • **Light Armor Mastery** ![Skill](/icons/skill0233.webp) [Passivo] (Recarga: `N/A`) — +12% EVA com armadura leve *(Maestria leve.)*
...
* **ID:** `treasureHunter` | **Ícone da Classe:** `/icons/treasure_hunter.webp`
* **Descrição:** Caçador de tesouros, mestre em adagas. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Shadow Step** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `15s`) — Teleporta atrás do alvo *(Passo sombrio.)*
        ...
        • **TH's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% Crit, +25% EVA, +20% ATK 25min *(Harmonia do caçador.)*
        • **Evasion** ![Skill](/icons/skill4093.webp) [Passivo] (Recarga: `N/A`) — +12% EVA *(Evasão aprimorada.)*
        • **Critical Power** ![Skill](/icons/skill4085.webp) [Passivo] (Recarga: `N/A`) — +18% Crit Damage *(Poder crítico.)*
        • **Focus** ![Skill](/icons/skill0019.webp) [Passivo] (Recarga: `N/A`) — +10% Crit Rate *(Foco em pontos vitais.)*
...
* **Descrição:** Aventureiro supremo, mestre da evasão e dano furtivo. Skills anteriores permanecem.
    --- Skills:
        • **Exciting Adventure** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `55 min`) — +45% EVA, +30% Crit, +20% ATK 20min *(Aventura emocionante.)*
        • **Wind Riding** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — +80% Speed + invisível por 10s *(Cavalgando o vento.)*
        • **Lucky Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Dano 420% + chance loot 2x *(Golpe de sorte.)*
        • **Detection** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `20s`) — Revela invisíveis em área *(Detecção de ocultos.)*
        • **Transcendent Deadly Blow** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `150s`) — Dano 650% + ignora EVA + bleed 12s *(Golpe mortal transcendente.)*
        • **Adventurer's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% Crit, +45% EVA, +35% ATK 30min *(Harmonia suprema.)*
        ...
        • **Final Frenzy** ![Skill](/icons/skill0176.webp) [Passivo] (Recarga: `N/A`) — +25% ATK quando HP < 30% *(Frenesi final.)*

---

## ⚔️ Linhagem: Sagittarius (HUMAN)
...
* **Descrição:** Arqueiro de elite com dano à distância. Skills anteriores permanecem.
    --- Skills:
        • **Double Shot** ![Skill](/icons/skill0019.webp) [Ativo] (Recarga: `10s`) — 2 disparos, dano total 260% *(Duplo disparo aprimorado.)*
        • **Burst Shot** ![Skill](/icons/skill0024.webp) [Ativo] (Recarga: `14s`) — Dano 280% + knockback *(Disparo explosivo.)*
        • **Stun Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano 220% + stun 3s *(Disparo atordoante.)*
        ...
        • **Cheap Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Dano 200% + slow 30% por 8s *(Disparo sujo.)*
        • **Hawkeye's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +25% Crit, +15% Range 25min *(Harmonia do olho de falcão.)*
        ...
        • **Focus** ![Skill](/icons/skill0019.webp) [Passivo] (Recarga: `N/A`) — +10% Crit Rate *(Concentração.)*
        • **Critical Power** ![Skill](/icons/skill4085.webp) [Passivo] (Recarga: `N/A`) — +18% Crit Damage *(Poder crítico.)*
        • **Evasion** ![Skill](/icons/skill4093.webp) [Passivo] (Recarga: `N/A`) — +10% EVA *(Evasão.)*
...
* **Descrição:** Atirador lendário, mestre do arco. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Pinpoint Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `28s`) — Dano 400% + ignora 50% DEF *(Tiro preciso.)*
        • **Triple Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `14s`) — 3 disparos, dano total 360% *(Tiro triplo.)*
        • **Thorn Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `12s`) — Dano 260% + bleed 10s *(Flecha de espinhos.)*
        • **Binding Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano 220% + root 4s *(Flecha aprisionadora.)*
        • **Incendiary Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Dano fogo 280% + burn 8s *(Flecha incendiária.)*
        • **Freezing Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Dano gelo 260% + slow 40% 6s *(Flecha congelante.)*
        • **Wind Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Dano vento 270% + knockback *(Flecha do vento.)*
        • **Flame Arrow Rain** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `28s`) — AoE fogo 380% (10 alvos) + burn *(Chuva de flechas flamejantes.)*
        • **Water Arrow Rain** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `28s`) — AoE gelo 360% (10 alvos) + slow *(Chuva de flechas gélidas.)*
        • **Storm Arrow Rain** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `28s`) — AoE vento 370% (10 alvos) + stun 2s *(Chuva de flechas tempestuosas.)*
        • **Spiral Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `24s`) — Dano 420% + penetra múltiplos alvos *(Tiro espiral perfurante.)*
        • **Target Lock** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Marca alvo: +40% dano contra ele 12s *(Trava de mira.)*
        ...
        • **Sagittarius' Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% ATK, +50% Crit, +40% Range 30min *(Harmonia do sagitário.)*
...
## ⚔️ Linhagem: Archmage (HUMAN)

### Classe Base Lvl 1-19: Human Mage ![Icon](/icons/mage.webp)
...
* **Descrição:** Classe base mágica humana.
    --- Skills:
        ...
        • **Sleep** ![Skill](/icons/skill3080.webp) [Ativo] (Recarga: `30s`) — Adormece alvo 8s (cancela dano) *(Sono mágico.)*
        • **Mage's Will** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `30 min`) — +10% M.ATK, +10% M.DEF 15min *(Vontade do mago.)*
        • **Robe Mastery** ![Skill](/icons/skill0234.webp) [Passivo] (Recarga: `N/A`) — +10% M.DEF, +8% Cast Speed com robe *(Maestria em vestes.)*
        • **MP Increase** ![Skill](/icons/skill0213.webp) [Passivo] (Recarga: `N/A`) — +8% Max MP *(Reserva mágica.)*

### Primeira Classe lvl 20-39: Wizard ![Icon](/icons/wizard.webp)
...
* **Descrição:** Mago elemental versátil. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Wizard's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `45 min`) — +25% M.ATK, +15% Cast Speed 20min *(Harmonia do mago.)*
...
* **Descrição:** Mestre da magia elemental ofensiva. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Sorcerer's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% M.ATK, +20% Cast Speed 25min *(Harmonia do feiticeiro.)*
...
* **Descrição:** Arquimago do fogo, dano massivo. Skills anteriores permanecem. Foco: FOGO.
    --- Skills:
        • **Meteor** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `180s`) — Dano fogo AoE 750% + burn 12s + knockdown *(METEORO — devastação absoluta.)*
        • **Hell Inferno** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Dano fogo 450% + burn 10s *(Inferno ardente.)*
        • **Flame Explosion** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Dano fogo 420% + 2 hits *(Explosão flamejante (2 hits).)*
        • **Fire Spiral** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano fogo 380% + penetra alvos *(Espiral de fogo perfurante.)*
        ...
        • **Archmage's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% M.ATK, +35% Cast Speed, +20% MP 30min *(Harmonia do arquimago.)*
        • **Master of Magic** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% M.ATK, +10% fire dmg, +5% PvE *(Mestre da magia.)*
        • **Spell Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% M. Skill Power *(Maestria em feitiços.)*
        • **Magic Focus** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +8% M. Crit Rate *(Foco mágico.)*
...
* **Descrição:** Mago das trevas e mortos-vivos. Skills anteriores permanecem. Foco: DARK/UNDEAD.
    --- Skills:
        ...
        • **Vampiric Claw** ![Skill](/icons/skill1159.webp) [Ativo] (Recarga: `14s`) — Dano 240% + drain 35% HP *(Garra vampírica.)*
        • **Anchor** ![Skill](/icons/skill1170.webp) [Ativo] (Recarga: `22s`) — Root no alvo 6s + dano 180% *(Âncora sombria.)*
        • **Curse: Gloom** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — -25% ATK e M.ATK do alvo 12s *(Maldição da melancolia.)*
        • **Corpse Burst** ![Skill](/icons/skill1157.webp) [Ativo] (Recarga: `25s`) — Explode cadáver: AoE 350% dark *(Explosão de cadáver.)*
        • **Summon Reanimated Man** ![Skill](/icons/skill1129.webp) [Ativo] (Recarga: `60s`) — Invoca morto-vivo (ATK 50% do dono) *(Reanimar morto.)*
        • **Summon Cursed Bone** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `45s`) — Invoca esqueleto (ATK 40% do dono) *(Esqueleto amaldiçoado.)*
        • **Dark Flame** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — AoE dark 250% ao redor *(Chamas sombrias.)*
        • **Surrender to Unholy** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — -25% Dark Resist no alvo 15s *(Vulnerabilidade ao dark.)*
        • **Curse Fear** ![Skill](/icons/skill1169.webp) [Ativo] (Recarga: `40s`) — Medo AoE 5s (3 alvos) *(Medo amaldiçoado.)*
        • **Necro's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% M.ATK, +20% drain, +15% HP 25min *(Harmonia do necromante.)*
...
* **Descrição:** Ceifador de almas, dano dark massivo. Skills anteriores permanecem. Foco: DARK.
    --- Skills:
        ...
        • **Void Explosion** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `180s`) — Dano dark 700% + 2 hits + silence 5s *(Explosão do vazio.)*
        • **Mass Curse: Gloom** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `35s`) — AoE -30% ATK/M.ATK (8 alvos) 12s *(Maldição em massa.)*
        • **Soul Absorption** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Drena 40% MP do alvo como MP próprio *(Absorção de almas.)*
        • **Summon Dark Curse** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `90s`) — Invoca entidade dark (ATK 70% do dono) *(Maldição sombria viva.)*
        • **Dark Burden** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `28s`) — -40% Speed no alvo 10s + dano 300% *(Fardo das trevas.)*
        ...
        • **Soultaker's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% M.ATK, +40% drain, +25% HP 30min *(Harmonia do ceifador.)*
        • **Master of Dark Magic** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% M.ATK, +10% dark dmg, +5% PvE *(Mestre da magia negra.)*
        • **Spell Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% M. Skill Power *(Maestria em feitiços.)*
...
* **Descrição:** Invocador de criaturas das trevas. Skills anteriores permanecem. Foco: SUMMON.
    --- Skills:
        ...
        • **Summon Phantom Cubic** ![Skill](/icons/skill0033.webp) [Ativo] (Recarga: `45s`) — Cubic que causa dano dark contínuo *(Cubic fantasma.)*
        • **Life Cubic** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `45s`) — Cubic que cura dono 5%/5s *(Cubic vital.)*
        • **Warlock's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% M.ATK, +25% Summon ATK 25min *(Harmonia do warlock.)*
...
* **ID:** `arcanaLord` | **Ícone da Classe:** `/icons/arcana_lord.webp`
* **Descrição:** Senhor arcano dos invocadores. Skills anteriores permanecem. Foco: SUMMON.
    --- Skills:
        ...
        • **Mass Servitor Heal** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Cura todos summons 40% HP *(Cura em massa dos servitors.)*
        ...
        • **Arcana Lord's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% M.ATK, +60% Summon Power 30min *(Harmonia do senhor arcano.)*
...
* **Descrição:** Clérigo curador e suporte. Skills anteriores permanecem.
    --- Skills:
        • **Heal** ![Skill](/icons/skill1401.webp) [Ativo] (Recarga: `8s`) — Cura 25% HP alvo *(Cura básica.)*
        • **Battle Heal** ![Skill](/icons/skill1015.webp) [Ativo] (Recarga: `10s`) — Cura 20% HP + remove 1 debuff *(Cura de combate.)*
        • **Might** ![Skill](/icons/skill3080.webp) [Party-Buff] (Recarga: `25 min`) — +15% ATK para party 10 min *(Bênção de força.)*
        • **Shield (Buff)** ![Skill](/icons/skill0000.webp) [Party-Buff] (Recarga: `25 min`) — +15% DEF para party 10 min *(Bênção de proteção.)*
        ...
        • **Cleric's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `45 min`) — +20% M.ATK, +20% Heal Power 20min *(Harmonia do clérigo.)*
...
* **Descrição:** Bispo curador poderoso. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Purify** ![Skill](/icons/skill1018.webp) [Ativo] (Recarga: `20s`) — Remove 3 debuffs do alvo *(Purificação.)*
        ...
        • **Holy Strike** ![Skill](/icons/skill1027.webp) [Ativo] (Recarga: `18s`) — Dano holy 320% + undead 2x *(Golpe sagrado.)*
        ...
        • **Bishop's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% Heal, +25% M.ATK, +20% M.DEF 25min *(Harmonia do bispo.)*
...
* **Descrição:** Cardeal supremo, mestre da cura E do dano sagrado (Dark Side). Skills anteriores permanecem.
    --- Skills:
        ...
        • **Mass Resurrection** ![Skill](/icons/skill1016.webp) [Ativo] (Recarga: `300s`) — Ressuscita toda party com 40% HP *(Ressurreição em massa.)*
        ...
        • **Dark Side** ![Skill](/icons/skill0000.webp) [Toggle] (Recarga: `N/A`) — Troca: -60% Heal, +80% M.ATK holy *(LADO SOMBRIO — transforma healer em DPS.)*
        • **Holy Burst** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `20s`) — Dano holy AoE 400% (Dark Side only) *(Explosão sagrada (apenas Dark Side).)*
        ...
        • **Cardinal's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% Heal, +40% M.ATK, +30% M.DEF 30min *(Harmonia do cardeal.)*
        • **Master of Healing** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% Heal Power, +5% PvE *(Mestre da cura.)*
...
* **Descrição:** Profeta, mestre dos buffs. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Focus** ![Skill](/icons/skill0019.webp) [Self-Buff] (Recarga: `50 min`) — +15% Crit Rate por 20 min *(Foco bélico.)*
        ...
        • **Holy Strike** ![Skill](/icons/skill1027.webp) [Ativo] (Recarga: `14s`) — Dano holy 280% *(Golpe sagrado.)*
        • **Prophet's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% ATK, +25% M.ATK, +20% DEF 25min *(Harmonia do profeta.)*
...
* **Descrição:** Hierofante, profeta supremo com profecias e dano. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Holy Punishment** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano holy 400% + silence 5s *(Punição sagrada.)*
        ...
        • **Transcendent Holy Burst** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `180s`) — Dano holy AoE 650% + stun 4s + purge *(Explosão sagrada transcendente.)*
        • **Hierophant's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% ATK, +45% M.ATK, +35% DEF 30min *(Harmonia do hierofante.)*
...
## ⚔️ Linhagem: Death Knight (HUMAN)

### Classe Base Lvl 1-19: Death Pilgrim ![Icon](/icons/hell_knight.webp)
* **ID:** `deathPilgrim` | **Ícone da Classe:** `/icons/hell_knight.webp`
* **Descrição:** Peregrino da morte — começo da jornada dark.
    --- Skills:
        • **Death Spike** ![Skill](/icons/skill1148.webp) [Ativo] (Recarga: `8s`) — Dano dark 160% 
        • **Soul Drain** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `12s`) — Dano 140% + drain 20% HP 
        • **DP Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — Gera Death Points ao atacar/matar 

### Primeira Classe lvl 20-39: Death Blade ![Icon](/icons/hell_knight.webp)
* **ID:** `deathBlade` | **Ícone da Classe:** `/icons/hell_knight.webp`
* **Descrição:** Lâmina da morte — combate dark agressivo.
    --- Skills:
        ...
        • **Dark Shield** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Absorve 2000 dano dark por 12s 
        • **Dark Weapon** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `45 min`) — +20% Dark Damage por 20 min 

### segunda Classe lvl 40-75: Death Messenger ![Icon](/icons/hell_knight.webp)
* **ID:** `deathMessenger` | **Ícone da Classe:** `/icons/hell_knight.webp`
* **Descrição:** Mensageiro da morte — ataques dark devastadores.
    --- Skills:
        • **Dark Explosion** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano AoE dark 300% + poison 6s 
        • **Death Mark** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Marca alvo: +30% Dark Damage recebido 10s 
        • **Abyss Gaze** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Dano dark 260% + fear 3s 
        • **Dark Armor** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `50 min`) — +25% DEF e +15% Dark Resist por 20 min 
        • **Death Messenger's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +25% Dark Damage, +20% DEF por 25 min 

### Terceira Classe lvl 76+: Death Knight ![Icon](/icons/hell_knight.webp)
* **ID:** `deathKnight` | **Ícone da Classe:** `/icons/hell_knight.webp`
* **Descrição:** Cavaleiro da Morte — devastação dark absoluta com Death Points.
    --- Skills:
        • **Death Storm** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Dano AoE dark 450% + drain HP AoE 20% 
        • **Deadly Counter** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Contra-ataque dark 400% quando bloqueado 
        • **Ultimate Death Knight** ![Skill](/icons/skill0176.webp) [Ativo] (Recarga: `120s`) — +80% ATK e Dark Damage por 30s (consume todos DP) 
        ...
        • **Death Knight Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% ATK, +50% Dark Damage, +35% DEF por 30 min 

---

## ⚔️ Linhagem: Warg (HUMAN)

### Terceira Classe lvl 76+: Warg ![Icon](/icons/warlord.webp)
* **ID:** `warg` | **Ícone da Classe:** `/icons/warlord.webp`
...
## ⚔️ Linhagem: Assassin (HUMAN)

### Classe Base Lvl 1-19: Assassin ![Icon](/icons/assasin.webp)
* **ID:** `assassinS0` | **Ícone da Classe:** `/icons/assasin.webp`
* **Descrição:** Caçador das sombras com adagas.
    --- Skills:
        • **Assassination** ![Skill](/icons/skill0432.webp) [Ativo] (Recarga: `8s`) — Dano 170% + gera 1 Assassin Dagger 
        ...
        • **Light Armor Mastery** ![Skill](/icons/skill0233.webp) [Passivo] (Recarga: `N/A`) — +8% EVA com armadura leve 

### Primeira Classe lvl 20-39: Assassin ![Icon](/icons/assasin.webp)
* **ID:** `assassinS1` | **Ícone da Classe:** `/icons/assasin.webp`
* **Descrição:** Primeira transferência de classe
    --- Skills:
        • **Shadow Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `14s`) — Dano 240% por trás + crit garantido 
        • **Blade Rush** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `12s`) — Avança 200% + gera 1 Assassin Dagger 
...
### segunda Classe lvl 40-75: Assassin ![Icon](/icons/abyss_walker.webp)
* **ID:** `assassinS2` | **Ícone da Classe:** `/icons/abyss_walker.webp`
* **Descrição:** Assassino com sistema de sombras desbloqueado.
    --- Skills:
        • **Phantom Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Dano 280% + invoca sombra no local 
        • **Lethal Shadow** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano 340% + sombra ataca junto (340%) 
        • **Resolve to Kill** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60s`) — Ativa Brutality: +40% ATK por 20s (requer 3 Daggers) 
        • **Chain Kill** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano 260% + reset Assassination CD se matar 
        • **Shadow Step** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `20s`) — Teleporta atrás do alvo 
        ...
        • **Assassin Harmony (Stage 2)** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +30% Crit, +25% EVA por 25 min 

### Terceira Classe lvl 76+: Assassin ![Icon](/icons/ghost_hunter.webp)
* **ID:** `assassinS3` | **Ícone da Classe:** `/icons/ghost_hunter.webp`
* **Descrição:** Assassino supremo — sombras letais e execuções instantâneas.
    --- Skills:
        • **Shadow Blast** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `35s`) — Todas as sombras explodem: dano AoE 450% cada 
        • **Transcendent Assassination** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `180s`) — Dano 700% + invoca 3 sombras + crit garantido 
        • **Change Appearance** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `120s`) — Visual exclusivo + invisibilidade 10s 
        • **Master of Shadows** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +25% ATK, +20% Crit, sombras ganham +50% dano 
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Assassin's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% ATK, +50% Crit, +40% EVA por 30 min 

---

## ⚔️ Linhagem: Eva's Templar (ELF)

### Classe Base Lvl 1-19: Elf Fighter ![Icon](/icons/fighter.webp)
* **ID:** `elfFighter` | **Ícone da Classe:** `/icons/fighter.webp`
...
* **ID:** `elvenKnight` | **Ícone da Classe:** `/icons/elven_knight.webp`
* **Descrição:** Cavaleiro élfico com escudo. Skills anteriores permanecem.
    --- Skills:
        • **Shield Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `10s`) — Dano 160% + taunt 5s *(Golpe de escudo.)*
        ...
        • **Heavy Armor Mastery** ![Skill](/icons/skill0231.webp) [Passivo] (Recarga: `N/A`) — +15% DEF armadura pesada *(Maestria pesada.)*
        • **Shield Mastery** ![Skill](/icons/skill0153.webp) [Passivo] (Recarga: `N/A`) — +15% Block Rate *(Maestria em escudos.)*
        • **Sword/Blunt Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% ATK espada/blunt *(Maestria em espadas.)*
...
* **ID:** `templeKnight` | **Ícone da Classe:** `/icons/temple_knight.webp`
* **Descrição:** Cavaleiro do templo de Eva. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Ultimate Defense** ![Skill](/icons/skill0110.webp) [Ativo] (Recarga: `120s`) — +80% DEF, -50% ATK por 15s *(Defesa absoluta.)*
        • **Provoke** ![Skill](/icons/skill0286.webp) [Ativo] (Recarga: `8s`) — Taunt + aggro *(Provocação.)*
        ...
        • **TK's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% DEF, +25% HP, +15% EVA 25min *(Harmonia do cavaleiro do templo.)*
        • **Boost HP** ![Skill](/icons/skill0211.webp) [Passivo] (Recarga: `N/A`) — +15% Max HP *(HP reforçado.)*
...
* **ID:** `evaTemplar` | **Ícone da Classe:** `/icons/evas_templar.webp`
* **Descrição:** Templário de Eva, tank divino aquático. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Shield of Eva** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `90s`) — Absorve 5000 dano por 15s *(Escudo de Eva.)*
        • **Celestial Shield** ![Skill](/icons/skill1418.webp) [Ativo] (Recarga: `300s`) — Party imune a dano por 5s *(Escudo celestial.)*
        • **Aqua Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano water 380% + slow 40% 6s *(Golpe aquático.)*
        • **Summon Guardian Agathion** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `120s`) — Invoca agathion protetor (+15% DEF) *(Agathion guardião.)*
        • **Transcendent Shield Charge** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `160s`) — Rush + 480% dano + AoE taunt 10s *(Investida transcendente.)*
        • **Eva's Templar Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% DEF, +40% HP, +25% M.DEF 30min *(Harmonia suprema.)*
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% ATK, +15% aggro, +5% PvE *(Mestre do combate.)*
...
* **Descrição:** Bardo élfico com canções de buff. Skills anteriores permanecem.
    --- Skills:
        • **Song of Earth** ![Skill](/icons/skill0264.webp) [Self-Buff] (Recarga: `50 min`) — +20% DEF por 20 min *(Canção da terra.)*
        ...
        • **Song of Wind** ![Skill](/icons/skill0268.webp) [Self-Buff] (Recarga: `50 min`) — +20% ATK Speed por 20 min *(Canção do vento.)*
        • **Song of Hunter** ![Skill](/icons/skill0269.webp) [Self-Buff] (Recarga: `50 min`) — +15% Crit Rate por 20 min *(Canção do caçador.)*
        ...
        • **SS's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% ATK, +20% DEF, +15% Speed 25min *(Harmonia do bardo.)*
        • **Heavy Armor Mastery** ![Skill](/icons/skill0231.webp) [Passivo] (Recarga: `N/A`) — +12% DEF armadura pesada *(Maestria pesada.)*
...
* **ID:** `swordMuse` | **Ícone da Classe:** `/icons/sword_muse.webp`
* **Descrição:** Musa da espada, bardo supremo com DPS. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Sonic Slash** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `20s`) — Dano 380% + AoE 5 alvos *(Corte sônico.)*
        • **Melody Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano 350% + stun 2s *(Golpe melódico.)*
        • **Transcendent Melody** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `180s`) — Dano AoE 550% + all songs refreshed *(Melodia transcendente.)*
        • **Sword Muse Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% ATK, +40% DEF, +30% Song Power 30min *(Harmonia da musa.)*
        • **Sword Muse Spirit** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% Song effectiveness *(Espírito da musa.)*
        • **Body of Sword Muse** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% Max HP, +10% Max MP *(Corpo da musa.)*

---

## ⚔️ Linhagem: Wind Rider (ELF)
...
### Primeira Classe lvl 20-39: Scout ![Icon](/icons/rogue.webp)
* **ID:** `elfScout` | **Ícone da Classe:** `/icons/rogue.webp`
...
* **ID:** `plainsWalker` | **Ícone da Classe:** `/icons/plain_walker.webp`
* **Descrição:** Caminhante das planícies, dagger stealth. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Fake Death** ![Skill](/icons/skill0060.webp) [Ativo] (Recarga: `60s`) — Finge morte, perde aggro *(Morte falsa.)*
        • **Trick** ![Skill](/icons/skill0011.webp) [Ativo] (Recarga: `20s`) — Remove alvo do inimigo *(Truque evasivo.)*
        • **PW's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% Crit, +25% EVA, +20% ATK 25min *(Harmonia do caminhante.)*
        • **Evasion** ![Skill](/icons/skill4093.webp) [Passivo] (Recarga: `N/A`) — +12% EVA *(Evasão aprimorada.)*
        • **Critical Power** ![Skill](/icons/skill4085.webp) [Passivo] (Recarga: `N/A`) — +18% Crit Damage *(Poder crítico.)*
        • **Focus** ![Skill](/icons/skill0019.webp) [Passivo] (Recarga: `N/A`) — +10% Crit Rate *(Concentração.)*

### Terceira Classe lvl 76+: Wind Rider ![Icon](/icons/wind_rider.webp)
* **ID:** `windRider` | **Ícone da Classe:** `/icons/wind_rider.webp`
* **Descrição:** Cavaleiro do vento, dagger supremo. Skills anteriores permanecem.
    --- Skills:
        • **Wind Riding** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — +80% Speed + invisível 10s *(Cavalgando o vento.)*
        • **Exciting Adventure** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `55 min`) — +45% EVA, +30% Crit, +20% ATK 20min *(Aventura élfica.)*
        • **Lucky Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Dano 420% + chance loot 2x *(Golpe de sorte.)*
        • **Transcendent Deadly Blow** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `150s`) — Dano 650% + ignora EVA + bleed 12s *(Golpe mortal transcendente.)*
        • **Wind Rider Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% Crit, +45% EVA, +35% ATK 30min *(Harmonia suprema.)*
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% ATK, +10% Crit, +5% PvE *(Mestre do combate.)*
        • **Shadow Sense** ![Skill](/icons/skill0294.webp) [Passivo] (Recarga: `N/A`) — +15% EVA à noite/dungeon *(Sentido das sombras.)*
        • **Wind Rider Spirit** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% dagger ATK *(Espírito do cavaleiro do vento.)*
        • **Body of Wind Rider** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% Max HP, +8% EVA *(Corpo do vento.)*
        • **Final Frenzy** ![Skill](/icons/skill0176.webp) [Passivo] (Recarga: `N/A`) — +25% ATK quando HP < 30% *(Frenesi final.)*

---

## ⚔️ Linhagem: Moonlight Sentinel (ELF)
...
* **ID:** `silverRanger` | **Ícone da Classe:** `/icons/silver_ranger.webp`
* **Descrição:** Arqueiro prateado élfico. Skills anteriores permanecem.
    --- Skills:
        ...
        • **SR's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +25% Crit, +15% Range 25min *(Harmonia do ranger.)*
        • **Bow Mastery** ![Skill](/icons/skill0208.webp) [Passivo] (Recarga: `N/A`) — +18% ATK com arco *(Maestria em arcos.)*
...
* **ID:** `moonlightSentinel` | **Ícone da Classe:** `/icons/moonlight_sentinel.webp`
* **Descrição:** Sentinela do luar, arqueiro supremo élfico. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Spiral Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `24s`) — Dano 420% + penetra alvos *(Tiro espiral.)*
        • **Target Lock** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Marca alvo: +40% dano 12s *(Trava de mira.)*
        • **Transcendent Seven Arrow** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `180s`) — Dano 700% + elemental + ignora DEF *(Sete flechas transcendentes.)*
        • **Moonlight Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% ATK, +50% Crit, +40% Range 30min *(Harmonia do luar.)*
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% ATK, +10% Range, +5% PvE *(Mestre do combate.)*
...
## ⚔️ Linhagem: Mystic Muse (ELF)

### Classe Base Lvl 1-19: Elf Mage ![Icon](/icons/mage.webp)
* **ID:** `elfMage` | **Ícone da Classe:** `/icons/mage.webp`
* **Descrição:** Mago élfico da natureza.
    --- Skills:
        • **Wind Strike** ![Skill](/icons/skill1177.webp) [Ativo] (Recarga: `8s`) — Dano vento 160% *(Rajada de vento.)*
        • **Ice Bolt** ![Skill](/icons/skill1184.webp) [Ativo] (Recarga: `8s`) — Dano gelo 155% + slow 15% 4s *(Projétil de gelo.)*
        • **Self Heal** ![Skill](/icons/skill1216.webp) [Ativo] (Recarga: `25s`) — Cura 20% HP *(Autocura.)*
        • **Sleep** ![Skill](/icons/skill3080.webp) [Ativo] (Recarga: `30s`) — Adormece alvo 8s *(Sono mágico.)*
        • **Robe Mastery** ![Skill](/icons/skill0234.webp) [Passivo] (Recarga: `N/A`) — +10% M.DEF, +8% Cast Speed *(Maestria em vestes.)*
        • **MP Increase** ![Skill](/icons/skill0213.webp) [Passivo] (Recarga: `N/A`) — +8% Max MP *(Reserva mágica.)*

### Primeira Classe lvl 20-39: Elven Wizard ![Icon](/icons/elven_wizard.webp)
* **ID:** `elvenWizard` | **Ícone da Classe:** `/icons/elven_wizard.webp`
* **Descrição:** Mago élfico elemental. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Wizard's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `45 min`) — +25% M.ATK, +15% Cast Speed 20min *(Harmonia do mago élfico.)*
...
* **Descrição:** Cantor de magias, foco em água e vento. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Body to Mind** ![Skill](/icons/skill1157.webp) [Ativo] (Recarga: `30s`) — Converte 15% HP em 30% MP *(Corpo em mente.)*
        • **SS's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% M.ATK, +20% Cast Speed 25min *(Harmonia do cantor.)*
        • **Elemental Assault** ![Skill](/icons/skill1292.webp) [Passivo] (Recarga: `N/A`) — +12% elemental damage *(Assalto elemental.)*

### Terceira Classe lvl 76+: Mystic Muse ![Icon](/icons/mystic_muse.webp)
* **ID:** `mysticMuse` | **Ícone da Classe:** `/icons/mystic_muse.webp`
* **Descrição:** Musa mística, mestre da magia aquática. Skills anteriores permanecem. Foco: WATER.
    --- Skills:
        ...
        • **Water Spiral** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `20s`) — Dano water 400% + penetra alvos *(Espiral de água perfurante.)*
        ...
        • **Mystic Muse Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% M.ATK, +35% Cast Speed, +20% MP 30min *(Harmonia da musa.)*
...
## ⚔️ Linhagem: Elemental Master (ELF)
...
* **ID:** `elementalSummoner` | **Ícone da Classe:** `/icons/elemental_summoner.webp`
* **Descrição:** Invocador elemental élfico. Skills anteriores permanecem. Foco: SUMMON.
    --- Skills:
        ...
        • **Summon Unicorn Mirage** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — Invoca unicórnio mago (M.ATK 50%) *(Unicórnio ilusório.)*
        • **Summon Unicorn Merrow** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `90s`) — Invoca merrow (ATK 65%, tank) *(Merrow aquático.)*
        • **Servitor Heal** ![Skill](/icons/skill1127.webp) [Ativo] (Recarga: `12s`) — Cura summon 35% HP *(Cura do servitor.)*
        • **Servitor Recharge** ![Skill](/icons/skill1126.webp) [Ativo] (Recarga: `15s`) — Restaura 30% MP do summon *(Recarga do servitor.)*
        • **Transfer Pain** ![Skill](/icons/skill1262.webp) [Toggle] (Recarga: `N/A`) — 50% dano recebido vai pro summon *(Transferência de dor.)*
        • **Summon Life Cubic** ![Skill](/icons/skill0067.webp) [Ativo] (Recarga: `45s`) — Cubic que cura 5%/5s *(Cubic vital.)*
        • **ES's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% M.ATK, +25% Summon ATK 25min *(Harmonia do invocador.)*
        • **Servitor Physical ATK** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% Summon ATK *(Poder do servitor.)*

### Terceira Classe lvl 76+: Elemental Master ![Icon](/icons/elemental_master.webp)
* **ID:** `elementalMaster` | **Ícone da Classe:** `/icons/elemental_master.webp`
* **Descrição:** Mestre elemental, invocador supremo élfico. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Mass Servitor Heal** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Cura todos summons 40% HP *(Cura em massa.)*
        ...
        • **Elemental Master Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% M.ATK, +60% Summon Power 30min *(Harmonia suprema.)*
        • **Unicorn's Friendship** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +20% Summon ATK/DEF *(Amizade dos unicórnios.)*
        • **Elemental Concentration** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% M.ATK, +10% Summon HP *(Concentração elemental.)*
...
### Primeira Classe lvl 20-39: Oracle ![Icon](/icons/cleric.webp)
* **ID:** `elfOracle` | **Ícone da Classe:** `/icons/cleric.webp`
* **Descrição:** Oráculo élfico curador. Skills anteriores permanecem.
    --- Skills:
        • **Heal** ![Skill](/icons/skill1401.webp) [Ativo] (Recarga: `8s`) — Cura 25% HP alvo *(Cura básica.)*
        • **Battle Heal** ![Skill](/icons/skill1015.webp) [Ativo] (Recarga: `10s`) — Cura 20% HP + remove 1 debuff *(Cura de combate.)*
        • **Might** ![Skill](/icons/skill3080.webp) [Party-Buff] (Recarga: `25 min`) — +15% ATK party 10 min *(Bênção de força.)*
        • **Shield (Buff)** ![Skill](/icons/skill0000.webp) [Party-Buff] (Recarga: `25 min`) — +15% DEF party 10 min *(Bênção de proteção.)*
        • **Cure Poison** ![Skill](/icons/skill1012.webp) [Ativo] (Recarga: `5s`) — Remove poison *(Cura veneno.)*
        • **Cure Bleed** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `5s`) — Remove bleed *(Estanca sangramento.)*
        • **Recharge** ![Skill](/icons/skill3080.webp) [Ativo] (Recarga: `12s`) — Restaura 20% MP alvo *(Recarga de mana.)*

### segunda Classe lvl 40-75: Elder ![Icon](/icons/elder.webp)
* **ID:** `elfElder` | **Ícone da Classe:** `/icons/elder.webp`
* **Descrição:** Ancião élfico, curador e buffer. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Purify** ![Skill](/icons/skill1018.webp) [Ativo] (Recarga: `20s`) — Remove 3 debuffs *(Purificação.)*
        ...
        • **Mental Shield** ![Skill](/icons/skill1035.webp) [Party-Buff] (Recarga: `30 min`) — +20% M.DEF party 12 min *(Escudo mental.)*
        • **Elder's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% Heal, +25% M.ATK 25min *(Harmonia do ancião.)*
        • **Resist Aqua** ![Skill](/icons/skill1182.webp) [Passivo] (Recarga: `N/A`) — +10% Water Resist *(Resistência aquática.)*

### Terceira Classe lvl 76+: Eva's Saint ![Icon](/icons/evas_saint.webp)
* **ID:** `evaSaint` | **Ícone da Classe:** `/icons/evas_saint.webp`
* **Descrição:** Santa de Eva, curadora suprema élfica. Skills anteriores permanecem.
    --- Skills:
        ...
        • **Balance Life** ![Skill](/icons/skill1335.webp) [Ativo] (Recarga: `60s`) — Equaliza HP de toda party *(Equilíbrio vital.)*
        • **Mass Resurrection** ![Skill](/icons/skill1016.webp) [Ativo] (Recarga: `300s`) — Ressuscita toda party 40% HP *(Ressurreição em massa.)*
        ...
        • **Dark Side** ![Skill](/icons/skill0000.webp) [Toggle] (Recarga: `N/A`) — Troca: -60% Heal, +80% M.ATK holy *(Lado sombrio.)*
        • **Aqua Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano water 380% + slow 40% 6s *(Golpe aquático.)*
        • **Divine Nova** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Dano holy AoE 450% + blind 5s *(Nova divina.)*
        • **Eva's Saint Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% Heal, +40% M.ATK, +30% M.DEF 30min *(Harmonia suprema.)*
        • **Master of Healing** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% Heal Power, +5% PvE *(Mestre da cura.)*
...
## ⚔️ Linhagem: Shillien Templar (DARKELF)

### Classe Base Lvl 1-19: Dark Elf Fighter ![Icon](/icons/fighter.webp)
* **ID:** `darkElfFighter` | **Ícone da Classe:** `/icons/fighter.webp`
* **Descrição:** Lutador sombrio com afinidade natural para dano crítico.
    --- Skills:
        ...
        • **Light Armor Mastery** ![Skill](/icons/skill0233.webp) [Passivo] (Recarga: `N/A`) — +8% DEF com armadura leve 
        • **Dark Spirit** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `30 min`) — +10% ATK e +8% Crit por 15 min 

### Primeira Classe lvl 20-39: Palus Knight ![Icon](/icons/palus_knight.webp)
* **ID:** `palusKnight` | **Ícone da Classe:** `/icons/palus_knight.webp`
* **Descrição:** Cavaleiro sombrio com escudo e poder dark.
    --- Skills:
        • **Shield Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `12s`) — Dano 160% + taunt 8s 
        ...
        • **Heavy Armor Mastery** ![Skill](/icons/skill0231.webp) [Passivo] (Recarga: `N/A`) — +15% DEF com armadura pesada 
        • **Sword/Blunt Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% ATK com espada/maça 
...
* **ID:** `shillienKnight` | **Ícone da Classe:** `/icons/shillien_knight.webp`
* **Descrição:** Cavaleiro de Shillien com dreno e terror.
    --- Skills:
        ...
        • **Judgment** ![Skill](/icons/skill0401.webp) [Ativo] (Recarga: `28s`) — Dano dark 300% + reduz heal 50% 
        • **Dark Flame** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano AoE dark 260% 
        ...
        • **Provoke** ![Skill](/icons/skill0286.webp) [Ativo] (Recarga: `15s`) — Taunt 10s 
        • **Summon Dark Cubic** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `45s`) — Cubo dark que ataca 130%/6s 
        • **Boost HP** ![Skill](/icons/skill0211.webp) [Passivo] (Recarga: `N/A`) — +15% Max HP 
        • **Shillien Knight's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% DEF, +25% ATK, +20% Dark Damage por 25 min 

### Terceira Classe lvl 76+: Shillien Templar ![Icon](/icons/shillien_templar.webp)
* **ID:** `shillienTemplar` | **Ícone da Classe:** `/icons/shillien_templar.webp`
* **Descrição:** Templário de Shillien — tanque sombrio com AoE devastador.
    --- Skills:
        ...
        • **Shield of Shillien** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — Absorve 5000 dano + reflete 20% dark por 15s 
        • **Celestial Shield** ![Skill](/icons/skill1418.webp) [Ativo] (Recarga: `180s`) — Imunidade total 7s + taunt AoE 
        • **Abyss Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Dano dark AoE 400% + slow 40% 
        • **Shillien's Curse** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `28s`) — Dano dark AoE 360% + reduz DEF 20% 
        • **Summon Guardian Agathion** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `90s`) — Agathion protetor (+15% DEF party) 
        • **Transcendent Abyss Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `160s`) — Dano dark AoE 600% + fear 3s + drain 30% 
        ...
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Shillien Templar Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% DEF, +40% Max HP, +30% Dark Damage por 30 min 

---

## ⚔️ Linhagem: Spectral Dancer (DARKELF)
...
* **Descrição:** Dançarino de lâminas — danças que fortalecem aliados.
    --- Skills:
        • **Dance of Fire** ![Skill](/icons/skill0000.webp) [Party-Buff] (Recarga: `30s`) — +20% ATK para o grupo 
        • **Dance of Fury** ![Skill](/icons/skill0275.webp) [Party-Buff] (Recarga: `30s`) — +20% ATK Speed para o grupo 
        ...
        • **Dance of Warrior** ![Skill](/icons/skill0271.webp) [Party-Buff] (Recarga: `30s`) — +15% P.ATK e DEF para o grupo 
        ...
        • **Heavy Armor Mastery** ![Skill](/icons/skill0231.webp) [Passivo] (Recarga: `N/A`) — +15% DEF com armadura pesada 
        • **Boost HP** ![Skill](/icons/skill0211.webp) [Passivo] (Recarga: `N/A`) — +15% Max HP 
        • **Blade Dancer's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% ATK, +20% ATK Speed, +15% EVA por 25 min 

### Terceira Classe lvl 76+: Spectral Dancer ![Icon](/icons/spectral_dancer.webp)
* **ID:** `spectralDancer` | **Ícone da Classe:** `/icons/spectral_dancer.webp`
* **Descrição:** Dançarina espectral — danças supremas e ataques devastadores.
    --- Skills:
        ...
        • **Dance of Blade Storm** ![Skill](/icons/skill0000.webp) [Party-Buff] (Recarga: `30s`) — +20% Crit Power para o grupo 
        ...
        • **Shadow Slash** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano dark 380% + bleed 6s 
        • **Dark Dance Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Dano AoE dark 420% + slow 40% 5s 
        ...
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Spectral Dancer Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% ATK, +35% ATK Speed, +30% EVA por 30 min 

---

## ⚔️ Linhagem: Ghost Hunter (DARKELF)
...
### Primeira Classe lvl 20-39: Assassin ![Icon](/icons/assasin.webp)
* **ID:** `assassinDE` | **Ícone da Classe:** `/icons/assasin.webp`
* **Descrição:** Assassino das sombras — mestre em emboscadas e venenos.
    --- Skills:
        • **Double Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `10s`) — Dano duplo 170% (2 hits) 
        ...
        • **Light Armor Mastery** ![Skill](/icons/skill0233.webp) [Passivo] (Recarga: `N/A`) — +10% EVA com armadura leve 
        • **Dagger Mastery** ![Skill](/icons/skill0209.webp) [Passivo] (Recarga: `N/A`) — +12% ATK com adagas 
...
* **ID:** `abyssWalker` | **Ícone da Classe:** `/icons/abyss_walker.webp`
* **Descrição:** Caminhante do Abismo — golpes fatais nas sombras.
    --- Skills:
        ...
        • **Shadow Step** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `15s`) — Teleporta para alvo + dano 180% 
        ...
        • **Evasion** ![Skill](/icons/skill4093.webp) [Passivo] (Recarga: `N/A`) — +12% EVA 
        • **Critical Power** ![Skill](/icons/skill4085.webp) [Passivo] (Recarga: `N/A`) — +20% Crit Power 
        • **Focus** ![Skill](/icons/skill0019.webp) [Passivo] (Recarga: `N/A`) — +10% Crit Rate 
        • **Abyss Walker's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +25% Crit, +20% EVA por 25 min 

### Terceira Classe lvl 76+: Ghost Hunter ![Icon](/icons/ghost_hunter.webp)
* **ID:** `ghostHunter` | **Ícone da Classe:** `/icons/ghost_hunter.webp`
* **Descrição:** Caçador fantasma — o assassino definitivo das sombras.
    --- Skills:
        • **Exciting Adventure** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `28s`) — Dano 380% + reset cooldown de Deadly Blow 
        • **Wind Riding** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — +80% Move Speed + invisibilidade 8s 
        • **Lucky Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Dano 420% + 20% chance drop extra 
        • **Transcendent Deadly Blow** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `160s`) — Dano 620% + ignore DEF + bleed 8s 
        • **Shadow Sense** ![Skill](/icons/skill0294.webp) [Passivo] (Recarga: `N/A`) — +25% Crit Rate à noite ou em dungeon 
        • **Final Frenzy** ![Skill](/icons/skill0176.webp) [Passivo] (Recarga: `N/A`) — +30% ATK quando HP < 30% 
        ...
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Ghost Hunter Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% ATK, +45% Crit, +35% EVA por 30 min 

---

## ⚔️ Linhagem: Ghost Sentinel (DARKELF)
...
* **ID:** `phantomRanger` | **Ícone da Classe:** `/icons/phantom_ranger.webp`
* **Descrição:** Atirador fantasma — flechas envenenadas e precisas.
    --- Skills:
        • **Double Shot** ![Skill](/icons/skill0019.webp) [Ativo] (Recarga: `10s`) — Dano 220% (2 hits) 
        • **Burst Shot** ![Skill](/icons/skill0024.webp) [Ativo] (Recarga: `14s`) — Dano 260% + knockback 
        • **Stun Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano 200% + stun 2s 
        ...
        • **Hex Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Dano 220% + curse (reduz DEF 20%) 
        ...
        • **Critical Power** ![Skill](/icons/skill4085.webp) [Passivo] (Recarga: `N/A`) — +20% Crit Power 
        • **Evasion** ![Skill](/icons/skill4093.webp) [Passivo] (Recarga: `N/A`) — +12% EVA 
        • **Phantom Ranger's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +25% Crit, +20% Range por 25 min 

### Terceira Classe lvl 76+: Ghost Sentinel ![Icon](/icons/ghost_sentinel.webp)
* **ID:** `ghostSentinel` | **Ícone da Classe:** `/icons/ghost_sentinel.webp`
* **Descrição:** Sentinela fantasma — atirador de elite com flechas elementais.
    --- Skills:
        ...
        • **Pinpoint Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano 380% + ignore DEF 
        • **Triple Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `15s`) — Dano 340% (3 hits rápidos) 
        • **Thorn Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `12s`) — Dano 260% + bleed 6s 
        • **Binding Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano 220% + root 4s 
        • **Wind Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `15s`) — Dano vento 280% + knockback 
        • **Spiral Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Dano 400% + penetra múltiplos alvos 
        • **Target Lock** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `35s`) — Marca alvo: +30% dano contra ele por 10s 
        ...
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Ghost Sentinel Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% ATK, +45% Crit, +35% Range por 30 min 

---

## ⚔️ Linhagem: Storm Screamer (DARKELF)

### Classe Base Lvl 1-19: Dark Elf Mage ![Icon](/icons/mage.webp)
* **ID:** `darkElfMage` | **Ícone da Classe:** `/icons/mage.webp`
* **Descrição:** Mago sombrio com magia negra poderosa.
    --- Skills:
        ...
        • **Sleep** ![Skill](/icons/skill3080.webp) [Ativo] (Recarga: `25s`) — Adormece alvo 8s (cancela ao tomar dano) 
        • **Robe Mastery** ![Skill](/icons/skill0234.webp) [Passivo] (Recarga: `N/A`) — +10% M.ATK com robe 
        • **MP Increase** ![Skill](/icons/skill0213.webp) [Passivo] (Recarga: `N/A`) — +10% Max MP 
        • **Dark Mage's Will** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `30 min`) — +10% M.ATK e +8% Cast Speed por 15 min 

### Primeira Classe lvl 20-39: Dark Wizard ![Icon](/icons/dark_wizard.webp)
* **ID:** `darkWizard` | **Ícone da Classe:** `/icons/dark_wizard.webp`
* **Descrição:** Mago sombrio com magia elemental e dreno de vida.
    --- Skills:
        ...
        • **Dark Wizard's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `50 min`) — +20% M.ATK, +15% Cast Speed por 20 min 
...
* **Descrição:** Mago do vento sombrio — devastação elemental com foco em Wind.
    --- Skills:
        ...
        • **Spellhowler's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% M.ATK, +25% Cast Speed, +15% Wind Damage por 25 min 

### Terceira Classe lvl 76+: Storm Screamer ![Icon](/icons/storm_screamer.webp)
* **ID:** `stormScreamer` | **Ícone da Classe:** `/icons/storm_screamer.webp`
* **Descrição:** Arauto da tempestade — mago devastador com foco em vento e trovão.
    --- Skills:
        ...
        • **Wind Spiral** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano vento 360% + penetra alvos em linha 
        • **Thunder Explosion** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `35s`) — Dano trovão AoE 520% (2 hits) + stun 2s 
        ...
        • **Spell Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% M.ATK, +10% Magic Crit Rate 
        • **Magic Focus** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +5% M.Skill Power, +10% PvE Damage 
        • **Mastery (Rare)** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% M.Skill Power, +15% PvE Damage, +15% Max MP 
        • **Storm Screamer Spirit** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +20% M.ATK, +15% Wind Damage, +10% Cast Speed 
        • **Body of Storm Screamer** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% Max MP, +10% MP Regen 
        • **Storm Screamer Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% M.ATK, +40% Cast Speed, +30% Wind Damage por 30 min 

---

## ⚔️ Linhagem: Spectral Master (DARKELF)
...
* **ID:** `phantomSummoner` | **Ícone da Classe:** `/icons/phantom_summoner.webp`
* **Descrição:** Invocador sombrio — invoca criaturas das trevas para lutar.
    --- Skills:
        ...
        • **Summon Spectral Lord** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — Invoca Spectral Lord (AoE + tanque) 
        ...
        • **Summon Phantom Cubic** ![Skill](/icons/skill0033.webp) [Ativo] (Recarga: `45s`) — Cubo dark que ataca 150%/8s 
        • **Servitor Physical Attack** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +20% ATK dos summons 
        • **Phantom Summoner's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% Summon Power, +20% M.ATK por 25 min 

### Terceira Classe lvl 76+: Spectral Master ![Icon](/icons/spectral_master.webp)
* **ID:** `spectralMaster` | **Ícone da Classe:** `/icons/spectral_master.webp`
* **Descrição:** Mestre espectral — summons supremos das trevas.
    --- Skills:
        ...
        • **Mass Servitor Heal** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Cura todos os summons 40% 
        ...
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Spectral Master Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% Summon Power, +40% M.ATK por 30 min 

---

## ⚔️ Linhagem: Shillien Saint (DARKELF)
...
* **ID:** `shillienOracle` | **Ícone da Classe:** `/icons/cleric.webp`
* **Descrição:** Oráculo de Shillien — cura e proteção sombria.
    --- Skills:
        • **Heal** ![Skill](/icons/skill1401.webp) [Ativo] (Recarga: `8s`) — Cura 250% M.ATK 
        • **Battle Heal** ![Skill](/icons/skill1015.webp) [Ativo] (Recarga: `5s`) — Cura rápida 180% M.ATK 
        • **Might** ![Skill](/icons/skill3080.webp) [Party-Buff] (Recarga: `20s`) — +10% ATK para o grupo 
        • **Shield** ![Skill](/icons/skill0092.webp) [Party-Buff] (Recarga: `20s`) — +10% DEF para o grupo 
...
* **ID:** `shillienElder` | **Ícone da Classe:** `/icons/shillien_elder.webp`
* **Descrição:** Anciã de Shillien — cura, buffs e magia dark ofensiva.
    --- Skills:
        ...
        • **Purify** ![Skill](/icons/skill1018.webp) [Ativo] (Recarga: `15s`) — Remove 2 debuffs 
        ...
        • **Shillien Elder's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% Heal Power, +25% M.ATK, +20% M.DEF por 25 min 

### Terceira Classe lvl 76+: Shillien Saint ![Icon](/icons/shillien_saint.webp)
* **ID:** `shillienSaint` | **Ícone da Classe:** `/icons/shillien_saint.webp`
* **Descrição:** Santa de Shillien — cura suprema + modo ofensivo Dark Side.
    --- Skills:
        ...
        • **Mass Resurrection** ![Skill](/icons/skill1016.webp) [Ativo] (Recarga: `300s`) — Ressuscita todos aliados mortos com 40% HP/MP 
        ...
        • **Dark Side** ![Skill](/icons/skill0000.webp) [Toggle] (Recarga: `10s toggle`) — ON: -50% Heal, +80% M.ATK dark, skills mudam para ofensivo 
        • **Dark Disruption** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `15s`) — Dano dark 360% (só em Dark Side) 
        ...
        • **Shillien Saint Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% Heal Power, +40% M.ATK, +30% M.DEF por 30 min 

---

## ⚔️ Linhagem: Blood Rose (DARKELF)

### Classe Base Lvl 1-19: Blood Rose ![Icon](/icons/abyss_walker.webp)
* **ID:** `bloodRoseBase` | **Ícone da Classe:** `/icons/abyss_walker.webp`
* **Descrição:** Rosa de Sangue — mística dos Elfos Negros devota de Shillien, mestra de espinhos sombrios e roubo de vida.
    --- Skills:
        ...
        • **Dark Thorn Shield** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% M.DEF e reflete 10% do dano físico em espinhos 
        • **Sanguine Pulse** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `8s`) — Pulso de sangue: dano 140% + drena 30% em HP 
        • **Blood Rose Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `30 min`) — +20% M.ATK, +15% Vampirismo por 30 min 

### Primeira Classe lvl 20-39: Blood Rose ![Icon](/icons/abyss_walker.webp)
* **ID:** `bloodRoseS1` | **Ícone da Classe:** `/icons/abyss_walker.webp`
* **Descrição:** Rosa de Sangue — sacerdotisa das trevas com controle de espinhos sangrentos.
    --- Skills:
        ...
        • **Sanguine Drain** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `10s`) — Dano sombrio 200% + absorve 50% do dano em HP 
        • **Thorn Armor Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% M.ATK de Trevas e +10% Esquiva 
        • **Curse of Shillien** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Maldição das trevas: reduz P.DEF e M.DEF do alvo em 20% 

### segunda Classe lvl 40-75: Blood Rose ![Icon](/icons/abyss_walker.webp)
* **ID:** `bloodRoseS2` | **Ícone da Classe:** `/icons/abyss_walker.webp`
* **Descrição:** Rosa de Sangue — dominadora do jardim profano de Shillien.
    --- Skills:
        ...
        • **Bleeding Thorn Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +20% Dano Crítico Mágico e +15% Efeito de Sangramento 

### Terceira Classe lvl 76+: Blood Rose ![Icon](/icons/abyss_walker.webp)
* **ID:** `bloodRose` | **Ícone da Classe:** `/icons/abyss_walker.webp`
* **Descrição:** Rosa de Sangue — Rainha Suprema dos Espinhos de Shillien.
    --- Skills:
        ...
        • **Blood Thorn Storm** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `120s`) — Tempestade cataclísmica de espinhos sangrentos 820% + sangramento profundo 10s 
        • **Queen of Thorns Aura** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +25% Dano Mágico de Trevas, +20% Roubo de Vida Permanente 
        • **Blood Rose Ultimate Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +65% M.ATK, +40% Roubo de Vida, +30% Velocidade de Cast por 30 min 

---

## ⚔️ Linhagem: Titan (ORC)

### Classe Base Lvl 1-19: Orc Fighter ![Icon](/icons/orc_fighter.webp)
* **ID:** `orcFighter` | **Ícone da Classe:** `/icons/orc_fighter.webp`
...
### Primeira Classe lvl 20-39: Raider ![Icon](/icons/orc_raider.webp)
* **ID:** `raider` | **Ícone da Classe:** `/icons/orc_raider.webp`
* **Descrição:** Saqueador orc — ataques devastadores com armas pesadas.
    --- Skills:
        ...
        • **Spinning Slash** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `12s`) — Dano AoE 160% 
...
* **Descrição:** Destruidor — fúria descontrolada com dano massivo.
    --- Skills:
        ...
        • **War Cry** ![Skill](/icons/skill0078.webp) [Self-Buff] (Recarga: `60s`) — +25% ATK por 120s 
        • **Hammer Crush** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `20s`) — Dano 280% + stun 3s 
        • **Rush** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `12s`) — Avança para o alvo + dano 150% 
        ...
        • **Focus** ![Skill](/icons/skill0019.webp) [Passivo] (Recarga: `N/A`) — +10% Crit Rate 
        • **Boost HP** ![Skill](/icons/skill0211.webp) [Passivo] (Recarga: `N/A`) — +15% Max HP 
        • **Destroyer's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +20% HP, +15% ATK Speed por 25 min 
...
* **Descrição:** Titã — devastação absoluta com fúria imparável.
    --- Skills:
        • **Earthquake** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `35s`) — Dano AoE 400% + knockback + stun 2s 
        • **Real Target** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Dano 380% + ignore DEF 
        • **Fists of Fury** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Dano 350% (5 hits rápidos) 
        • **Soul Breaker** ![Skill](/icons/skill0281.webp) [Ativo] (Recarga: `28s`) — Dano 360% + drain MP alvo 
        • **Blazing Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano fogo 420% single target 
        • **Anti-Magic Armor** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — +80% M.DEF por 15s 
        • **Transcendent Earthquake** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `180s`) — Dano AoE 680% + knockdown + stun 4s 
        ...
        • **Titan's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% ATK, +40% HP, +30% ATK Speed por 30 min 

---

## ⚔️ Linhagem: Grand Khavatari (ORC)
...
### Primeira Classe lvl 20-39: Monk ![Icon](/icons/orc_monk.webp)
* **ID:** `monk` | **Ícone da Classe:** `/icons/orc_monk.webp`
...
* **Descrição:** Tirano — combate desarmado com fúria elemental.
    --- Skills:
        ...
        • **Cripple** ![Skill](/icons/skill0095.webp) [Ativo] (Recarga: `18s`) — Dano 220% + slow 40% 6s 
        ...
        • **Zealot** ![Skill](/icons/skill0420.webp) [Ativo] (Recarga: `60s`) — +50% ATK Speed por 15s, -20% DEF 
        • **Frenzy** ![Skill](/icons/skill0176.webp) [Ativo] (Recarga: `120s`) — +100% ATK quando HP < 30%, dura 30s 
        • **Tyrant's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +25% Crit, +20% ATK Speed por 25 min 

### Terceira Classe lvl 76+: Grand Khavatari ![Icon](/icons/grand_khavatari.webp)
* **ID:** `grandKhavatari` | **Ícone da Classe:** `/icons/grand_khavatari.webp`
* **Descrição:** Grande Khavatari — mestre supremo do combate desarmado.
    --- Skills:
        ...
        • **Ogre's Essence** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `120s`) — +40% ATK, +30% Max HP por 60s 
        ...
        • **Final Frenzy** ![Skill](/icons/skill0176.webp) [Passivo] (Recarga: `N/A`) — +30% ATK quando HP < 30% 
        • **Master of Combat: Orc** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% All Stats, +18% PvE Damage 
        • **Grand Khavatari Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% ATK, +40% Crit, +35% ATK Speed por 30 min 

---

## ⚔️ Linhagem: Grand Vanguard (ORC)

### Classe Base Lvl 1-19: Rider ![Icon](/icons/orc_raider.webp)
* **ID:** `rider` | **Ícone da Classe:** `/icons/orc_raider.webp`
* **Descrição:** Cavaleiro orc inicial — combate montado com lança.
    --- Skills:
        ...
        • **Lance Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% ATK com lança 
...
* **ID:** `dragoon` | **Ícone da Classe:** `/icons/destroyer.webp`
* **Descrição:** Dragão montado — ataques montados devastadores.
    --- Skills:
        ...
        • **Mounted Whirlwind** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano AoE 240% 
        • **Beast Roar** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Reduz ATK inimigos AoE -15% 8s + taunt 
        • **Dragoon's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `45 min`) — +20% ATK, +15% DEF, +10% HP por 20 min 

### segunda Classe lvl 40-75: Vanguard Rider ![Icon](/icons/titan.webp)
* **ID:** `vanguardRider` | **Ícone da Classe:** `/icons/titan.webp`
* **Descrição:** Cavaleiro de vanguarda — devastação montada com poder de dragão.
    --- Skills:
        ...
        • **Rider's Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +20% ATK montado, +15% DEF montado 
...
* **ID:** `grandVanguard` | **Ícone da Classe:** `/icons/titan.webp`
* **Descrição:** Grande Vanguarda — lorde dragão montado supremo.
    --- Skills:
        ...
        • **BP Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — Gera Battle Points ao atacar, +5% ATK por BP (max 5) 
        ...
        • **Master of Combat: Orc** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% All Stats, +18% PvE Damage 
        • **Vanguard's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% ATK, +45% DEF, +35% HP por 30 min 
        • **Rider's Will** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `55 min`) — +30% ATK Speed montado, +20% Move Speed por 20 min 

---

## ⚔️ Linhagem: Dominator (ORC)

### Classe Base Lvl 1-19: Orc Mage ![Icon](/icons/orc_mage.webp)
* **ID:** `orcMage` | **Ícone da Classe:** `/icons/orc_mage.webp`
...
### Primeira Classe lvl 20-39: Shaman ![Icon](/icons/orc_shaman.webp)
* **ID:** `shaman` | **Ícone da Classe:** `/icons/orc_shaman.webp`
...
* **Descrição:** Senhor da guerra — buffs de clã e debuffs massivos.
    --- Skills:
        ...
        • **Clan Shield** ![Skill](/icons/skill0000.webp) [Party-Buff] (Recarga: `30s`) — +15% DEF para o grupo 
        ...
        • **Provoke** ![Skill](/icons/skill0286.webp) [Ativo] (Recarga: `15s`) — Taunt 10s 
        • **Boost HP** ![Skill](/icons/skill0211.webp) [Passivo] (Recarga: `N/A`) — +15% Max HP 
        • **Overlord's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% M.ATK, +25% HP, +20% M.DEF por 25 min 
...
* **Descrição:** Dominador — líder absoluto com buffs supremos e dano ofensivo.
    --- Skills:
        ...
        • **Flame Burst** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano fogo AoE 380% + burn 6s 
        • **Prophecy of Pa'agrio** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `55 min`) — +30% ATK, +25% M.ATK, +20% PvE Damage por 20 min 
        ...
        • **Dominator Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% M.ATK, +40% HP, +30% All Resist por 30 min 

---

## ⚔️ Linhagem: Doomcryer (ORC)
...
* **Descrição:** Cantor de guerra — cânticos que empoderam aliados.
    --- Skills:
        ...
        • **Chant of Vampire** ![Skill](/icons/skill1310.webp) [Party-Buff] (Recarga: `30s`) — Drain 8% dano como HP para o grupo 
        ...
        • **Warcryer's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% M.ATK, +25% HP, +20% M.DEF por 25 min 
...
* **Descrição:** Arauto da perdição — cânticos supremos e dano de guerra.
    --- Skills:
        ...
        • **Blood Bond** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Dano AoE dark 380% + drain HP para grupo 
        • **Prophecy of Victory** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `55 min`) — +30% ATK, +25% Crit, +20% PvE Damage por 20 min 
        • **Cacophony of War** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Dano AoE 320% + reduz HP/MP inimigos -15% 
        ...
        • **Doomcryer Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% M.ATK, +40% HP, +30% All Resist por 30 min 

---

## ⚔️ Linhagem: Fortune Seeker (DWARF)

### Classe Base Lvl 1-19: Dwarf Fighter ![Icon](/icons/dwarven_fighter.webp)
* **ID:** `dwarfFighter` | **Ícone da Classe:** `/icons/dwarven_fighter.webp`
...
* **Descrição:** Sucateiro — mestre em obter loot extra dos inimigos.
    --- Skills:
        ...
        • **Stun Attack** ![Skill](/icons/skill0100.webp) [Ativo] (Recarga: `14s`) — Dano 160% + stun 2s 
        • **Dagger Mastery** ![Skill](/icons/skill0209.webp) [Passivo] (Recarga: `N/A`) — +12% ATK com adagas 
        • **Evasion** ![Skill](/icons/skill4093.webp) [Passivo] (Recarga: `N/A`) — +10% EVA 

### segunda Classe lvl 40-75: Bounty Hunter ![Icon](/icons/bounty_hunter.webp)
* **ID:** `bountyHunter` | **Ícone da Classe:** `/icons/bounty_hunter.webp`
* **Descrição:** Caçador de recompensas — combate e loot supremo.
    --- Skills:
        • **Spoil Festival** ![Skill](/icons/skill0254.webp) [Ativo] (Recarga: `25s`) — Marca todos inimigos AoE para loot 
        • **Spoil Crush** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `18s`) — Dano 240% + Spoil + Sweep automático 
        ...
        • **Focus** ![Skill](/icons/skill0019.webp) [Passivo] (Recarga: `N/A`) — +10% Crit Rate 
        • **Boost HP** ![Skill](/icons/skill0211.webp) [Passivo] (Recarga: `N/A`) — +15% Max HP 
        • **Bounty Hunter's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% ATK, +25% Crit, +20% Loot Bonus por 25 min 

### Terceira Classe lvl 76+: Fortune Seeker ![Icon](/icons/fortune_seeker.webp)
* **ID:** `fortuneSeeker` | **Ícone da Classe:** `/icons/fortune_seeker.webp`
* **Descrição:** Buscador de fortuna — loot máximo e combate eficiente.
    --- Skills:
        ...
        • **Aura of Fortune** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% Loot Rate, +20% Adena Drop por 30 min 
        ...
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Fortune Seeker Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% ATK, +40% Crit, +35% Loot Bonus por 30 min 

---

## ⚔️ Linhagem: Maestro (DWARF)
...
* **ID:** `artisanDwarf` | **Ícone da Classe:** `/icons/artisan.webp`
...
* **Descrição:** Ferreiro de guerra — golems poderosos e craft avançado.
    --- Skills:
        ...
        • **Crystal Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +20% chance cristalização bem-sucedida 
        • **Golem Armor** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — +30% DEF do golem por 60s 
        • **Warsmith's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% ATK, +25% Golem Power, +20% Craft Success por 25 min 
...
* **Descrição:** Maestro — mestre supremo da forja e dos golems.
    --- Skills:
        ...
        • **Craft Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +30% Craft Success Rate 
        ...
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Maestro Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% ATK, +40% Golem Power, +30% Craft Success por 30 min 

---

## ⚔️ Linhagem: ShineMaker (DWARF)

### Classe Base Lvl 1-19: High Elf ![Icon](/icons/paladin.webp)
* **ID:** `highElfBase` | **Ícone da Classe:** `/icons/paladin.webp`
* **Descrição:** Alto Elfo — poder sagrado e elemental inicial.
    --- Skills:
        • **Holy Light** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `8s`) — Dano sagrado 150% 
        • **Elemental Weave** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `8s`) — Dano elemental 140% 
        • **High Elf Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% P.ATK e M.ATK 
        • **MP Increase** ![Skill](/icons/skill0213.webp) [Passivo] (Recarga: `N/A`) — +10% Max MP 

### Primeira Classe lvl 20-39: ShineMaker ![Icon](/icons/warsmith.webp)
...
* **Descrição:** Primeira transferência de classe
    --- Skills:
        ...
        • **Radiant Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `12s`) — Dano sagrado 170% + blind 2s 
...
### segunda Classe lvl 40-75: ShineMaker ![Icon](/icons/warsmith.webp)
* **ID:** `shineMakerS2` | **Ícone da Classe:** `/icons/warsmith.webp`
* **Descrição:** Segunda transferência de classe
    --- Skills:
        ...
        • **Brilliant Aura** ![Skill](/icons/skill0000.webp) [Party-Buff] (Recarga: `60s`) — +15% All Stats para o grupo por 300s 
        • **ShineMaker Harmony (S2)** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% M.ATK, +25% Heal Power, +20% M.DEF por 25 min 

### Terceira Classe lvl 76+: ShineMaker ![Icon](/icons/warsmith.webp)
...
* **Descrição:** Criadora de luz — suporte sagrado anão com poder celestial e dano luminoso.
    --- Skills:
        ...
        • **ShineMaker's Ultimate Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% M.ATK, +50% P.DEF, +40% Cura por 30 min 

---

## ⚔️ Linhagem: Doombringer (KAMAEL)

### Classe Base Lvl 1-19: Kamael Soldier ![Icon](/icons/fighter.webp)
* **ID:** `kamaelSoldier` | **Ícone da Classe:** `/icons/fighter.webp`
* **Descrição:** Soldado Kamael — guerreiro com poder da alma.
    --- Skills:
        • **Soul Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `8s`) — Dano soul 160% 
        ...
        • **Light Armor Mastery** ![Skill](/icons/skill0233.webp) [Passivo] (Recarga: `N/A`) — +8% EVA com armadura leve 
        • **Ancient Sword Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% ATK com ancient sword 
        • **Soul Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% Soul Damage 
...
* **Descrição:** Combatente de linha — espada antiga e poder soul.
    --- Skills:
        ...
        • **Rush** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `12s`) — Avança para alvo + dano 150% 
...
* **Descrição:** Berserker Kamael — fúria soul com dano devastador.
    --- Skills:
        ...
        • **Soul Rage** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — +60% ATK por 20s, consume Soul Points 
        • **Rush Impact** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `18s`) — Charge 240% + stun 2s 
        ...
        • **Focus** ![Skill](/icons/skill0019.webp) [Passivo] (Recarga: `N/A`) — +10% Crit Rate 
        • **Berserker's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +25% Crit, +20% Soul Damage por 25 min 
...
* **Descrição:** Portador da ruína — devastação soul absoluta.
    --- Skills:
        ...
        • **Soul Rage (Enhanced)** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `90s`) — +80% ATK por 25s 
        • **Transcendent Doom Blade** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `180s`) — Dano soul 680% + ignore DEF + drain soul 
        • **Pride of Kamael** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +20% ATK, +15% Soul Damage, +10% Crit Rate 
        ...
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Doombringer Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% ATK, +45% Crit, +35% Soul Damage por 30 min 

---

## ⚔️ Linhagem: Soul Hound (KAMAEL)
...
* **ID:** `soulFinder` | **Ícone da Classe:** `/icons/rogue.webp`
* **Descrição:** Buscador de almas — combate misto físico/mágico.
    --- Skills:
        • **Soul Strike (Enhanced)** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `8s`) — Dano soul 180% 
        • **Double Thrust** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `10s`) — Dano 170% (2 hits) 
        • **Rapier Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% ATK com rapier 
...
* **ID:** `soulBreakerKamael` | **Ícone da Classe:** `/icons/abyss_walker.webp`
* **Descrição:** Quebrador de almas — misto combate/magia soul.
    --- Skills:
        ...
        • **Dark Curse** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano dark 240% + reduz M.DEF 20% 
        • **Insane Crusher** ![Skill](/icons/skill0484.webp) [Ativo] (Recarga: `18s`) — Dano físico 260% + stun 2s 
        • **Soul Breaker's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +30% ATK, +25% M.ATK, +20% Soul Damage por 25 min 

### Terceira Classe lvl 76+: Soul Hound ![Icon](/icons/ghost_hunter.webp)
* **ID:** `soulHound` | **Ícone da Classe:** `/icons/ghost_hunter.webp`
* **Descrição:** Cão da alma — mestre do combate híbrido.
    --- Skills:
        ...
        • **Dark Smash** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano dark 380% + silence 3s 
        ...
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Soul Hound Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +50% ATK, +45% M.ATK, +35% Soul Damage por 30 min 

---

## ⚔️ Linhagem: Trickster (KAMAEL)
...
* **Descrição:** Guardiã Kamael — especialista em crossbow.
    --- Skills:
        ...
        • **Crossbow Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% ATK com crossbow 
        • **Boost HP** ![Skill](/icons/skill0211.webp) [Passivo] (Recarga: `N/A`) — +10% Max HP 

### segunda Classe lvl 40-75: Soul Ranger ![Icon](/icons/silver_ranger.webp)
* **ID:** `soulRanger` | **Ícone da Classe:** `/icons/silver_ranger.webp`
* **Descrição:** Ranger soul — crossbow com poder da alma.
    --- Skills:
        ...
        • **Focus** ![Skill](/icons/skill0019.webp) [Passivo] (Recarga: `N/A`) — +10% Crit Rate 
        • **Critical Power** ![Skill](/icons/skill4085.webp) [Passivo] (Recarga: `N/A`) — +20% Crit Power 
        • **Soul Ranger's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +25% Crit, +20% Range por 25 min 
...
* **Descrição:** Trapaceiro — crossbow com armadilhas e truques.
    --- Skills:
        • **Seven Arrow (Crossbow)** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `28s`) — Dano 420% (7 hits crossbow) 
        ...
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Trickster Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +55% ATK, +45% Crit, +35% Range por 30 min 

---

## ⚔️ Linhagem: Samurai (KAMAEL)

### Classe Base Lvl 1-19: Bushi (Samurai) ![Icon](/icons/duelist.webp)
* **ID:** `samuraiBase` | **Ícone da Classe:** `/icons/duelist.webp`
* **Descrição:** Bushi — aprendiz do caminho da lâmina e técnicas de Katana.
    --- Skills:
        ...
        • **Katana Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% P.ATK com Katana/Espadas 
        • **Bushido Spirit** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +10% Taxa de Crítico e +8% Esquiva 
        • **Samurai's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `30 min`) — +20% P.ATK, +15% Crit Rate por 30 min 

### Primeira Classe lvl 20-39: Hatamoto ![Icon](/icons/gladiator.webp)
* **ID:** `hatamoto` | **Ícone da Classe:** `/icons/gladiator.webp`
* **Descrição:** Hatamoto — guerreiro de elite da lâmina com disciplina marcial.
    --- Skills:
        • **Whirlwind Cut** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `12s`) — Dano giratório AoE 210% 
        • **Focused Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `14s`) — Estocada concentrada: dano 250% + 30% bônus de dano crítico 
...
* **ID:** `ronin` | **Ícone da Classe:** `/icons/duelist.webp`
* **Descrição:** Ronin — espadachim solitário com técnicas devastadoras de corte.
    --- Skills:
        • **Sakura Storm** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano AoE pétalas cortantes 360% + sangramento contínuo 6s 
        • **Rising Dragon** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Corte ascendente do dragão: dano 340% + knockup 2s 
        • **Counter Slash** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `20s`) — Contra-ataque letal: dano 380% e absorve 20% do dano recebido 
...
* **ID:** `samurai` | **Ícone da Classe:** `/icons/duelist.webp`
* **Descrição:** Samurai — mestre supremo da lâmina com técnicas lendárias de Kenjutsu.
    --- Skills:
        ...
        • **Samurai's Ultimate Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% P.ATK, +50% Crit Rate, +35% Velocidade de Ataque por 30 min 

---

## ⚔️ Linhagem: Storm Blaster (SYLPH)

### Classe Base Lvl 1-19: Sylph Gunner ![Icon](/icons/hawkeye.webp)
* **ID:** `sylphGunner` | **Ícone da Classe:** `/icons/hawkeye.webp`
* **Descrição:** Atirador elemental Sylph.
    --- Skills:
        • **Quick Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `6s`) — Dano 150% rápido 
        • **Gun Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +12% ATK com arma de fogo 
        • **Light Armor Mastery** ![Skill](/icons/skill0233.webp) [Passivo] (Recarga: `N/A`) — +8% EVA com armadura leve 

### Primeira Classe lvl 20-39: Sharpshooter ![Icon](/icons/silver_ranger.webp)
* **ID:** `sharpshooter` | **Ícone da Classe:** `/icons/silver_ranger.webp`
* **Descrição:** Primeira transferência de classe
    --- Skills:
        • **Burst Fire** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `10s`) — Dano 200% (3 tiros rápidos) 
        • **Piercing Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `14s`) — Dano 220% + penetra alvos em linha 
        • **Evasive Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `12s`) — Dano 170% + esquiva para trás 
        • **Wind Walker** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% Move Speed 

### segunda Classe lvl 40-75: Wind Sniper ![Icon](/icons/phantom_ranger.webp)
* **ID:** `windSniper` | **Ícone da Classe:** `/icons/phantom_ranger.webp`
* **Descrição:** Segunda transferência de classe
    --- Skills:
        • **Snipe** ![Skill](/icons/skill0313.webp) [Ativo] (Recarga: `22s`) — Dano 380% long range + crit bônus 
        • **Rapid Fire** ![Skill](/icons/skill0413.webp) [Ativo] (Recarga: `45s`) — +50% ATK Speed por 15s 
        • **Explosive Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `18s`) — Dano AoE 280% 
        • **Chain Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Dano 260% + reset Quick Shot CD 
        • **Aimed Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `20s`) — Dano 340% + ignore DEF 
        • **Sylph's Grace** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% EVA, +10% Move Speed 
        • **Wind Sniper Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% ATK, +25% Crit, +20% Range por 25 min 

### Terceira Classe lvl 76+: Storm Blaster ![Icon](/icons/sagittarius.webp)
* **ID:** `stormBlaster` | **Ícone da Classe:** `/icons/sagittarius.webp`
* **Descrição:** Atirador da tempestade — devastação à distância com armas de fogo.
    --- Skills:
        • **Storm Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `25s`) — Dano vento 420% + knockback 
        • **Wind Barrage** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Dano AoE vento 380% 
        • **Transcendent Storm Shot** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `180s`) — Dano vento 680% + stun 3s + AoE 
        • **Storm Blaster Spirit** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +25% ATK, +20% Crit, +15% Wind Damage 
        • **Body of the Storm Blaster** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% Max HP, +10% EVA, +10% Move Speed 
        • **Master of Combat** ![Skill](/icons/skill0430.webp) [Passivo] (Recarga: `N/A`) — +10% All Stats, +15% PvE Damage 
        • **Storm Blaster Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% ATK, +50% Crit, +35% Wind Damage por 30 min 

---

## ⚔️ Linhagem: Divine Templar (HIGHELF)
...
### Primeira Classe lvl 20-39: Light Templar ![Icon](/icons/paladin.webp)
* **ID:** `lightTemplar` | **Ícone da Classe:** `/icons/paladin.webp`
* **Descrição:** Primeira transferência de classe
    --- Skills:
        • **Holy Strike** ![Skill](/icons/skill1027.webp) [Ativo] (Recarga: `10s`) — Dano sagrado 190% 
        • **Shield of Light** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `30s`) — Absorve 2500 dano + reflete holy 
        • **Holy Shield Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% DEF com escudo 
        • **Heavy Armor Mastery** ![Skill](/icons/skill0231.webp) [Passivo] (Recarga: `N/A`) — +15% DEF com armadura pesada 

### segunda Classe lvl 40-75: Holy Templar ![Icon](/icons/paladin.webp)
* **ID:** `holyTemplar` | **Ícone da Classe:** `/icons/paladin.webp`
* **Descrição:** Segunda transferência de classe
    --- Skills:
        ...
        • **Holy Chain** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `22s`) — Taunt + root alvo 4s 
        • **Divine Templar Harmony (S2)** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% DEF, +25% ATK, +20% M.DEF por 25 min 

### Terceira Classe lvl 76+: Divine Templar ![Icon](/icons/paladin.webp)
* **ID:** `divineTemplar` | **Ícone da Classe:** `/icons/paladin.webp`
* **Descrição:** Templário Divino — tanque sagrado com poder ofensivo e defesa suprema.
    --- Skills:
        • **Lord Knight** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `120s`) — Forma divina: +50% DEF e ATK por 30s + regen MP 
        • **Sacred Aegis** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `60s`) — +60% Block Rate + reflete holy 15s 
        • **Ultimate Divine Defense** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `300s`) — Imunidade total 10s + taunt AoE massivo 
        • **Divine Templar Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% DEF, +45% Max HP, +35% Holy Damage por 30 min 

---

## ⚔️ Linhagem: Element Weaver (HIGHELF)
...
### Primeira Classe lvl 20-39: Element Weaver ![Icon](/icons/archmage.webp)
* **ID:** `elementWeaverS1` | **Ícone da Classe:** `/icons/archmage.webp`
* **Descrição:** Primeira transferência de classe
    --- Skills:
        • **Fire Weave** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `10s`) — Dano fogo 200% 
        • **Ice Weave** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `10s`) — Dano gelo 190% + slow 20% 3s 
        • **Wind Weave** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `10s`) — Dano vento 190% 
        • **Robe Mastery** ![Skill](/icons/skill0234.webp) [Passivo] (Recarga: `N/A`) — +10% M.ATK com robe 

### segunda Classe lvl 40-75: Element Weaver ![Icon](/icons/archmage.webp)
* **ID:** `elementWeaverS2` | **Ícone da Classe:** `/icons/archmage.webp`
* **Descrição:** Segunda transferência de classe
    --- Skills:
        ...
        • **Elemental Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% All Elemental Damage 
        • **Element Weaver Harmony (S2)** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `60 min`) — +35% M.ATK, +25% Cast Speed, +20% Elemental Damage por 25 min 

### Terceira Classe lvl 76+: Element Weaver ![Icon](/icons/archmage.webp)
* **ID:** `elementWeaver` | **Ícone da Classe:** `/icons/archmage.webp`
* **Descrição:** Tecelão elemental — mestre supremo dos elementos.
    --- Skills:
        ...
        • **Tri-Element Storm** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `120s`) — Dano AoE 650% 
        • **Element Weaver Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% M.ATK, +50% Elemental Damage por 30 min 

---

## ⚔️ Linhagem: Eviscerator (ERTHEIA)
...
* **Descrição:** Lutadora Ertheia — mestre veloz de combate corporal com ventos de Sayha.
    --- Skills:
        • **Pummel Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `6s`) — Golpe rápido de punho: dano físico 160% 
        • **Sayha Wind Step** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `45s`) — +15% Esquiva e +15% Velocidade de Movimento 
        • **Fist Mastery** ![Skill](/icons/skill0210.webp) [Passivo] (Recarga: `N/A`) — +15% P.ATK com Garras/Punhos 
        • **Sayha's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `30 min`) — +20% P.ATK, +15% Velocidade de Ataque por 30 min 
...
* **Descrição:** Saqueadora — especialista em combos rápidos de vento e golpes aéreos.
    --- Skills:
        ...
        • **Wind Blend Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `10s`) — Investida com vento: dano 240% com +30% chance crítica 
...
### segunda Classe lvl 40-75: Eviscerator ![Icon](/icons/grand_khavatari.webp)
...
* **Descrição:** Evisceradora — guerreira marcial letal que corta o ar e destrói defesas.
    --- Skills:
        ...
        • **Eviscerate Slash** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `14s`) — Corte visceral: dano físico 380% com alto bônus crítico 
        • **Hurricane Spin Kick** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `15s`) — Chute furacão 360º: dano 340% em área 
        • **Wind Fighter Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +20% P.ATK, +20% Taxa de Crítico e +15% Velocidade de Ataque 
...
* **Descrição:** Evisceradora Imperial — mestre suprema de combate corporal com poder dimensional de Sayha.
    --- Skills:
        ...
        • **Eviscerator Ultimate Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +60% P.ATK, +40% Crit Power, +35% Velocidade de Ataque por 30 min 

---

## ⚔️ Linhagem: Sayha Seeker (ERTHEIA)

### Classe Base Lvl 1-19: Sayha Mage ![Icon](/icons/spellsinger.webp)
...
* **Descrição:** Mística Ertheia — invocadora elemental dos vendavais de Sayha.
    --- Skills:
        • **Sayha's Wind** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `6s`) — Rajada de vento cortante: dano mágico 160% 
        • **Wind Veil** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `45s`) — +15% M.ATK e +12% Esquiva por 60s 
        • **Ertheia Magic Mastery** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% M.ATK com Cajados 
        • **Sayha Seer's Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `30 min`) — +20% M.ATK, +20% Dano de Vento por 30 min 

### Primeira Classe lvl 20-39: Sayha Seeker ![Icon](/icons/spellsinger.webp)
...
* **Descrição:** Buscadora de Sayha — canalizadora de correntes de ar e tempestades.
    --- Skills:
        ...
        • **Eye of the Storm** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +15% Velocidade de Cast e +10% M.DEF 

### segunda Classe lvl 40-75: Sayha Seeker ![Icon](/icons/mystic_muse.webp)
...
* **Descrição:** Condutora dos Ventos — maga que comanda tufões devastadores.
    --- Skills:
        • **Typhoon Strike** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `16s`) — Tufão cortante: dano AoE de vento 360% 
        • **Cyclone Blast** ![Skill](/icons/skill0000.webp) [Ativo] (Recarga: `14s`) — Ciclone ascendente: dano 340% + knockup 2s 
        • **Wind Domain** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +20% Dano Elemental de Vento e +15% Taxa de Crítico Mágico 
...
* **Descrição:** Mestra Suprema de Sayha — soberana dos vendavais e tempestades de Aden.
    --- Skills:
        ...
        • **Wind Spirit Transcendence** ![Skill](/icons/skill0000.webp) [Passivo] (Recarga: `N/A`) — +25% M.ATK, +20% Dano Crítico Mágico, +20% Esquiva Permanente 
        • **Sayha Seeker Ultimate Harmony** ![Skill](/icons/skill0000.webp) [Self-Buff] (Recarga: `90 min`) — +65% M.ATK, +45% Dano de Vento, +35% Velocidade de Cast por 30 min 
