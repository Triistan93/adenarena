...
// CLASSES ÔÇö Ertheia (Marauder, Sayha Seer & Blood Rose)
// ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
export const ERTHEIA_CLASSES = {
  bloodRoseBase: {
    ...
    archetype: 'ertheia',
    stage: 0,
    desc: 'Lutadora m├¡stica Ertheia em sintonia com os ventos e espinhos.',
  ...
  marauder: {
    ...
    archetype: 'ertheia',
    stage: 1,
    desc: 'Saqueadora Ertheia com punhos do vento e golpes ├ígeis.',
  ...
  ertheiaWarrior: {
    ...
    archetype: 'ertheia',
    stage: 2,
    desc: 'Evisceradora de combate f├¡sico corporal e combos acelerados.',
  ...
  sayhaSeer: {
    ...
    archetype: 'ertheia',
    stage: 1,
    desc: 'Vidente de Sayha especialista em magias do vento e ilus├úo.',
  ...
  windRiderErth: {
    ...
    archetype: 'ertheia',
    stage: 2,
    desc: 'Buscador de Sayha com tempestades de vento e distor├º├úo espacial.',
  ...
  sayhaSeeker: {
    ...
    archetype: 'ertheia',
    stage: 3,
    desc: 'Buscador supremo de Sayha com rajadas a├®reas e voo ilus├│rio.',
  ...
  bloodRoseS1: {
    ...
    archetype: 'ertheia',
    stage: 1,
    desc: 'Rosa Sangrenta com ataques h├¡bridos de espinhos e dreno de vida.',
  ...
  bloodRoseS2: {
    ...
    archetype: 'ertheia',
    stage: 2,
    desc: 'Rosa Sangrenta avan├ºada com chicotes de rosas e lifesteal elevado.',
  ...
  bloodRose: {
    ...
    archetype: 'ertheia',
    stage: 3,
    desc: 'M├¡stica Ertheia com chicotes de espinhos, tempestades sangrentas e cura vamp├¡rica.',
