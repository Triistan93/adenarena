...
// CLASSES ÔÇö Dwarf (Bounty Hunter, Warsmith & ShineMaker)
// ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
...
export const DWARF_CLASSES = {
  artisan: {
    ...
    archetype: 'artisan',
    stage: 0,
    desc: 'Classe base an├ú de coleta e cria├º├úo.',
  ...
  scavenger: {
    ...
    archetype: 'artisan',
    stage: 1,
    desc: 'Coletor an├úo especialista em Spoil e extra├º├úo de materiais.',
  ...
  bountyHunter: {
    ...
    archetype: 'artisan',
    stage: 2,
    desc: 'Ca├ºador de recompensas com Spoil Crush e alto ganho de loot.',
  ...
  fortuneSeeker: {
    ...
    archetype: 'artisan',
    stage: 3,
    desc: 'Buscador da fortuna supremo com saque duplo e riqueza lend├íria.',
  ...
  artisanClass: {
    ...
    archetype: 'artisan',
    stage: 1,
    desc: 'Artes├úo mestre capaz de forjar equipamentos e invocar aut├┤matos.',
  ...
  warsmith: {
    ...
    archetype: 'artisan',
    stage: 2,
    desc: 'Ferreiro de guerra que invoca canh├Áes e aut├┤matos de cerco.',
  ...
  maestro: {
    ...
    archetype: 'artisan',
    stage: 3,
    desc: 'Maestro da forja com golems gigantes e receitas lend├írias.',
  ...
  shinemakerS1: {
    ...
    archetype: 'artisan',
    stage: 1,
    desc: 'Iniciando no caminho da luz cristalina e magia dos min├®rios.',
  ...
  shinemakerS2: {
    ...
    archetype: 'artisan',
    stage: 2,
    desc: 'Guerreiro an├úo cristalino de suporte e dano m├ígico radiante.',
  ...
  shinemaker: {
    ...
    archetype: 'artisan',
    stage: 3,
    desc: 'Mestre da luz cristalina ÔÇö DPS/Suporte supremo com martelos brilhantes.',
